...
(function () {
   ...
   */
  EditorUi.enableLogging = urlParams['stealth'] != '1' && urlParams['lockdown']
      != '1' &&
  ...
  EditorUi.isElectronApp = window != null && window.process != null &&
      window.process.versions != null && window.process.versions['electron']
      != null;
   ...
   */
  EditorUi.mermaidDiagramTypes = ['flowchart', 'classDiagram',
    'sequenceDiagram',
  ...
  EditorUi.logError = function (message, url, linenumber, colno, err, severity,
    ...
    if (message != null) {
      ...
      severity = (severity != null) ? severity : ((message.indexOf(
              'NetworkError') < 0 &&
          message.indexOf('SecurityError') < 0 && message.indexOf(
              'NS_ERROR_FAILURE') < 0 &&
          message.indexOf('out of memory') < 0) ? 'SEVERE' : 'CONFIG');

      try {
        if (EditorUi.enableLogging && urlParams['dev'] != '1' &&
            message != EditorUi.lastErrorMessage && message.indexOf(
                'extension:') < 0 &&
            err.stack.indexOf('extension:') < 0 && err.stack.indexOf(
                '<anonymous>:') < 0) {
    ...
    if (urlParams['dev'] == '1') {
      ...
      try {
        ...
        img.src = logDomain + '/images/1x1.png?' +
            'v=' + encodeURIComponent(EditorUi.VERSION) +
            ((data != null) ? '&data=' + encodeURIComponent(
                JSON.stringify(data)) : '');
      } catch (e) {
        // ignore
      }
  ...
  (function () {
    ...
    try {
      ...
      EditorUi.prototype.canvasSupported = !!(cnv.getContext && cnv.getContext(
          '2d'));
    } catch (e) {
      // ignore
    }
    ...
    try {
      ...
      img.onload = function () {
        try {
          ...
          EditorUi.prototype.useCanvasForExport = result != null
              && result.length > 6;
        } catch (e) {
          // ignore
        }
  ...
  EditorUi.prototype.isOffline = function (ignoreStealth) {
    return this.isOfflineApp() || !navigator.onLine || (!ignoreStealth
  ...
  EditorUi.prototype.isExternalDataComms = function () {
    return urlParams['offline'] != '1' && !this.isOffline()
        && !this.isOfflineApp();
  };
  ...
  EditorUi.prototype.createSpinner = function (x, y, size) {
    ...
    spinner.spin = function (container, label) {
      ...
      if (!this.active) {
        ...
        if (label != null) {
          if (autoPosition) {
            y = Math.max(document.body.clientHeight || 0,
          ...
          mxUtils.setPrefixedStyle(status.style, 'transform',
              'translate(-50%,-50%)');

          if (!Editor.isDarkMode()) {
            mxUtils.setPrefixedStyle(status.style, 'boxShadow',
                '2px 2px 3px 0px #ddd');
          }
  ...
  EditorUi.prototype.isCompatibleString = function (data) {
    try {
      ...
      return node != null && node.getElementsByTagName('parsererror').length
          == 0;
    } catch (e) {
      // ignore
    }
  ...
  EditorUi.prototype.isVisioData = function (data) {
    return data.length > 8 && ((data.charCodeAt(0) == 0xD0 && data.charCodeAt(1)
            == 0xCF &&
            data.charCodeAt(2) == 0x11 && data.charCodeAt(3) == 0xE0
            && data.charCodeAt(4) == 0xA1 && data.charCodeAt(5) == 0xB1 &&
            data.charCodeAt(6) == 0x1A && data.charCodeAt(7) == 0xE1)
        || (data.charCodeAt(0) == 0x50 && data.charCodeAt(1) == 0x4B &&
            data.charCodeAt(2) == 0x03 && data.charCodeAt(3) == 0x04)
        || (data.charCodeAt(0) == 0x50 && data.charCodeAt(1) == 0x4B &&
  ...
  EditorUi.prototype.isRemoteVisioData = function (data) {
    return data.length > 8 && ((data.charCodeAt(0) == 0xD0 && data.charCodeAt(1)
            ...
            && data.charCodeAt(4) == 0xA1 && data.charCodeAt(5) == 0xB1 &&
            data.charCodeAt(6) == 0x1A && data.charCodeAt(7) == 0xE1)
        || (data.charCodeAt(0) == 0x3C && data.charCodeAt(1) == 0x3F &&
            data.charCodeAt(2) == 0x78 && data.charCodeAt(3) == 0x6D
  ...
  EditorUi.prototype.createKeyHandler = function (editor) {
    ...
    if (!this.editor.chromeless || this.editor.editable) {
      ...
      keyHandler.getFunction = function (evt) {
        if (graph.isSelectionEmpty() && ui.pages != null && ui.pages.length
            > 0) {
          ...
          } else if (mxEvent.isControlDown(evt) || (mxClient.IS_MAC
  ...
  EditorUi.prototype.validateFileData = function (data) {
    if (data != null && data.length > 0) {
      ...
      if (index >= 0) {
        ...
        data = data.slice(0, index) + replaceString + data.slice(
            index + replaceStrLen - 1, data.length);
      }
  ...
  EditorUi.prototype.replaceFileData = function (data) {
    ...
    var node = (data != null && data.length > 0) ? mxUtils.parseXml(
    ...
    if (node != null) {
      ...
      try {
        ...
        if (nodes.length > 1 || (nodes.length == 1 && nodes[0].hasAttribute(
            'name'))) {
          this.fileNode = node;
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.createFileData = function (node, graph, file, url,
      forceXml, forceSvg, forceHtml,
    ...
    uncompressed = (uncompressed != null) ? uncompressed
        : !Editor.defaultCompressed;

    var editLink = null;
    var redirect = null;

    if (file == null || file.getMode() == App.MODE_DEVICE || file.getMode()
        == App.MODE_BROWSER) {
      editLink = '_blank';
    } else {
      editLink = url;
    ...
    if (node == null) {
      ...
      if (!compact) {
        ...
        if (fileNode.getElementsByTagName('diagram').length > 1 && this.pages
            != null) {
      ...
      var xml = (uncompressed) ? mxUtils.getPrettyXml(fileNode)
          : mxUtils.getXml(fileNode);

      // Writes the file as an embedded HTML file
      if (!forceSvg && !forceXml && (forceHtml || (file != null
          && /(\.html)$/i.test(file.getTitle())))) {
        xml = this.getHtml2(mxUtils.getXml(fileNode), graph,
            (file != null) ? file.getTitle() : null, editLink, redirect);
      }
      // Maps the XML data to the content attribute in the SVG node
      else if (forceSvg || (!forceXml && file != null && /(\.svg)$/i.test(
          file.getTitle()))) {
        if (file != null && (file.getMode() == App.MODE_DEVICE || file.getMode()
            == App.MODE_BROWSER)) {
          url = null;
  ...
  EditorUi.prototype.anonymizeNode = function (node, zeros) {
    ...
    for (var i = 0; i < nodes.length; i++) {
      ...
      if (nodes[i].parentNode != null && nodes[i].parentNode.nodeName != 'root'
        ...
        nodes[i].parentNode.parentNode.replaceChild(nodes[i],
            nodes[i].parentNode);
      }
    }
  ...
  EditorUi.prototype.synchronizeCurrentFile = function (forceReload) {
    ...
    if (currentFile != null) {
      ...
      } else if (this.spinner.spin(document.body,
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.getFileData = function (forceXml, forceSvg, forceHtml,
      embeddedCallback,
      ignoreSelection, currentPage, node, compact, file, uncompressed,
      resolveReferences) {
    ignoreSelection = (ignoreSelection != null) ? ignoreSelection : true;
    currentPage = (currentPage != null) ? currentPage : false;
    uncompressed = (uncompressed != null) ? uncompressed
    ...
    if (forceSvg || (!forceXml && file != null && /(\.svg)$/i.test(
        file.getTitle()))) {
      var darkTheme = graph.themes != null && graph.defaultThemeName
          == 'darkTheme';
      ...
      if (darkTheme || (this.pages != null && this.currentPage
          != this.pages[0])) {
   ...
   *
   */
  EditorUi.prototype.getHtml = function (node, graph, title, editLink, redirect,
      ignoreSelection) {
    ignoreSelection = (ignoreSelection != null) ? ignoreSelection : true;
    var bg = null;
    ...
    return ((redirect == null)
        ...
        '\n<head>\n' + ((redirect == null) ? ((title != null) ? '<title>'
            + mxUtils.htmlEntities(title) +
            '</title>\n' : '') : '<title>draw.io</title>\n') +
        ((redirect != null) ? '<meta http-equiv="refresh" content="0;URL=\''
            + redirect + '\'"/>\n' : '') +
        '</head>\n<body' +
        (((redirect == null && bg != null && bg != mxConstants.NONE)
            ? ' style="background-color:' + bg + ';">' : '>')) +
        '\n<div class="mxgraph" style="' + style + '">\n' +
        '<div style="width:1px;height:1px;overflow:hidden;">' + data
        + '</div>\n</div>\n' +
        ((redirect == null) ? '<script type="text/javascript" src="' + js
            + '"></script>' :
   ...
   */
  EditorUi.prototype.getHtml2 = function (xml, graph, title, editLink,
      redirect) {
    var js = window.DRAWIO_VIEWER_URL || EditorUi.drawHost
    ...
    return ((redirect == null)
        ...
        ((redirect != null) ? '<meta http-equiv="refresh" content="0;URL=\''
            + redirect + '\'"/>\n' : '') +
        '<meta charset="utf-8"/>\n</head>\n<body>' +
        '\n<div class="mxgraph" style="' + style + '" data-mxgraph="'
        + mxUtils.htmlEntities(JSON.stringify(data)) + '"></div>\n' +
        ((redirect == null) ? '<script type="text/javascript" src="' + js
            + '"></script>' :
            '<a style="position:absolute;top:50%;left:50%;margin-top:-128px;margin-left:-64px;" '
            +
  ...
  EditorUi.prototype.setFileData = function (data) {
    ...
    if (cause) {
      ...
      // Some nodes must be extracted here to find the mxfile node
      // LATER: Remove duplicate call to extractGraphModel in overridden setGraphXml
      var tmp = (node != null) ? this.editor.extractGraphModel(node, true)
          : null;
  ...
  EditorUi.prototype.getBaseFilename = function (ignorePageName) {
    ...
    var basename = (file != null && file.getTitle() != null) ? file.getTitle()
    ...
    if (!ignorePageName && this.pages != null && this.pages.length > 1 &&
        this.currentPage != null && this.currentPage.node.getAttribute('name')
        != null &&
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.downloadFile = function (format, uncompressed, addShadow,
      ignoreSelection,
      currentPage, pageVisible, transparent, scale, border, grid, includeXml,
      pageRange) {
    try {
      ...
      if (format == 'xml') {
        ...
        var data = this.getHtml2(this.getFileData(true), this.editor.graph,
            basename);
        this.saveData(filename, format, data, 'text/html');
      } else if ((format == 'svg' || format == 'xmlsvg') && this.spinner.spin(
          document.body, mxResources.get('export'))) {
        var svg = null;
        ...
        if (format == 'svg') {
          ...
          var svgRoot = this.editor.graph.getSvg(bg, null, null, null, null,
              ignoreSelection);
          ...
          this.editor.convertImages(svgRoot,
              mxUtils.bind(this, mxUtils.bind(this, function (svgRoot2) {
                this.spinner.stop();
          ...
          svg = this.getFileData(false, true, null,
        ...
        this.saveRequest(filename, format,
            mxUtils.bind(this, function (newTitle, base64) {
              try {
                ...
                var req = this.createDownloadRequest(newTitle, format,
                    ignoreSelection, base64,
  ...
  EditorUi.prototype.createDownloadRequest = function (filename, format,
      ignoreSelection,
    ...
    var params = this.downloadRequestBuilder(filename, format, ignoreSelection,
        base64,
        transparent, currentPage, scale, border, grid, includeXml, pageRange, w,
        h);
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.downloadRequestBuilder = function (filename, format,
      ignoreSelection,
      base64, transparent, currentPage, scale, border, grid, includeXml,
      pageRange, w, h) {
    var graph = this.editor.graph;
    ...
    if (bounds.width * bounds.height > MAX_AREA || data.length
        > MAX_REQUEST_SIZE) {
  ...
  EditorUi.prototype.loadDescriptor = function (desc, success, error) {
    ...
    var loadData = mxUtils.bind(this, function (data) {
      ...
      var xml = (desc.format != 'csv' && realData.length > 0) ? realData
      ...
      // Installs updates
      if (desc.update != null) {
        var interval = (desc.interval != null) ? parseInt(desc.interval)
            : 60000;
        ...
        try {
          ...
          while (node != null) {
            if (node.nodeName == 'update') {
              ...
              while (dataNode != null && dataNode.nodeType
      ...
      if (file != null) {
        ...
        if (file.isModified() && file.constructor == DriveFile &&
          ...
          var evt = {
            ...
            action: (discarded ? 'DISCARDED' : 'WARNED') + ((file.savingFile)
                    ? 'saving' : '') +
                ((file.savingFile && file.savingFileTime != null) ? '_' +
                    Math.round(
                        (Date.now() - file.savingFileTime.getTime()) / 1000)
                    : '') +
                ((file.saveLevel != null) ? ('-sl_' + file.saveLevel) : '') +
                '-age_' + ((file.ageStart != null) ? Math.round(
                    (Date.now() - file.ageStart.getTime()) / 1000) : 'x') +
                ((this.editor.autosave) ? '' : '-nosave') +
                ((file.isAutosave()) ? '' : '-noauto') +
                '-open_' + ((file.opened != null) ? Math.round(
                    (Date.now() - file.opened.getTime()) / 1000) : 'x') +
                '-save_' + ((file.lastSaved != null) ? Math.round(
                    (Date.now() - file.lastSaved.getTime()) / 1000) : 'x') +
                '-change_' + ((file.lastChanged != null) ? Math.round(
                    (Date.now() - file.lastChanged.getTime()) / 1000) : 'x') +
                '-alive_' + Math.round(
                    (Date.now() - App.startTime.getTime()) / 1000),
            label: ((file.sync != null) ? ('client_' + file.sync.clientId)
                    : 'nosync') +
                ((this.drive.user != null) ? ('-user_' + this.drive.user.id)
                    : '-nouser') + '-rev_' +
    ...
    if (file != null) {
      try {
        ...
        var fn = mxUtils.bind(this, function () {
          ...
          if (urlParams['url'] != null && this.spinner.spin(document.body,
              mxResources.get('reconnecting'))) {
  ...
  EditorUi.prototype.getHashValueForPages = function (pages, details) {
    ...
    for (var i = 0; i < pages.length; i++) {
      ...
      hash = ((hash << 5) - hash + this.hashValue(diagram,
          function (obj, key, value, isXml) {
            ...
            if (isXml && (obj.nodeName == 'mxGeometry' || obj.nodeName
                    == 'mxPoint') &&
                (key == 'x' || key == 'y' || key == 'width' || key
                    == 'height')) {
  ...
  EditorUi.prototype.hashValue = function (obj, replacer, details) {
    ...
    if (obj != null && typeof obj === 'object' && typeof obj.nodeType
        === 'number' &&
        typeof obj.nodeName === 'string' && typeof obj.getAttribute
        === 'function') {
      ...
      if (obj.attributes != null) {
        ...
        for (var i = 0; i < obj.attributes.length; i++) {
          ...
          var value = (replacer != null) ? replacer(obj, key,
              obj.attributes[i].value, true) : obj.attributes[i].value;
   ...
   * Hook for subclassers.
   */
  EditorUi.prototype.saveLibrary = function (name, images, file, mode, noSpin,
      noReload, fn) {
  };
  ...
  EditorUi.prototype.toggleScratchpad = function () {
    if (this.isScratchpadEnabled()) {
      if (this.scratchpad == null) {
        StorageFile.getFileContent(this, '.scratchpad',
  ...
  EditorUi.prototype.repositionLibrary = function (nextChild) {
    ...
    nextChild = (nextChild != null) ? nextChild
  ...
  EditorUi.prototype.loadLibrary = function (file, expand) {
    ...
    if (doc.documentElement.nodeName == 'mxlibrary') {
      ...
      this.libraryLoaded(file, images,
          doc.documentElement.getAttribute('title'), expand);
    } else {
  ...
  EditorUi.prototype.libraryLoaded = function (file, images, optionalTitle,
    ...
    if (file.isEditable()) {
      ...
      var editLibrary = mxUtils.bind(this, function (evt) {
        this.showLibraryDialog(file.getTitle(), contentDiv, images, file,
            file.getMode());
        mxEvent.consume(evt);
      });
      ...
      var saveLibrary = mxUtils.bind(this, function (evt) {
        ...
        if (file.isAutosave()) {
          ...
          title.style.paddingRight = (buttons.childNodes.length * btnWidth)
              + 'px';

          this.saveLibrary(file.getTitle(), images, file, file.getMode(), true,
              true, function () {
                if (spinBtn != null && spinBtn.parentNode != null) {
                  spinBtn.parentNode.removeChild(spinBtn);
                  title.style.paddingRight = (buttons.childNodes.length
                      * btnWidth) + 'px';
                }
              });
          ...
          mxEvent.addListener(saveBtn, 'click',
      ...
      var addCells = mxUtils.bind(this, function (cells, bounds, evt, title) {
        ...
        contentDiv.appendChild(this.sidebar.createVertexTemplateFromCells(
            cells, bounds.width, bounds.height, title || '', true, null,
            false));
        ...
        if (dropTarget != null && dropTarget.parentNode != null && images.length
            > 0) {
      ...
      var addSelection = mxUtils.bind(this, function (evt) {
        if (!graph.isSelectionEmpty()) {
          ...
          this.showError(mxResources.get('error'),
              mxResources.get('nothingIsSelected'), mxResources.get('ok'));
        }
      ...
      mxEvent.addGestureListeners(contentDiv, function () {
        ...
        if (graph.isMouseDown && graph.panningManager != null
          ...
          contentDiv.style.backgroundColor = (Editor.isDarkMode()) ? '#000000'
              : '#fefefe';
      ...
      if (Graph.fileSupport) {
        mxEvent.addListener(contentDiv, 'dragover',
            mxUtils.bind(this, function (evt) {
        ...
        mxEvent.addListener(contentDiv, 'drop',
            mxUtils.bind(this, function (evt) {
              contentDiv.style.cursor = '';
              contentDiv.style.backgroundColor = '';

              if (evt.dataTransfer.files.length > 0) {
                this.importFiles(evt.dataTransfer.files, 0, 0,
                    this.maxImageSize, mxUtils.bind(this,
                        function (data, mimeType, x, y, w, h, img, doneFn,
                            file) {
                          if (data != null && mimeType.substring(0, 6)
                              == 'image/') {
                            ...
                            var cells = [new mxCell('',
                                new mxGeometry(0, 0, w, h), style)];
                            cells[0].vertex = true;

                            addCells(cells, new mxRectangle(0, 0, w, h), evt,
                                (mxEvent.isAltDown(evt)) ? null : img.substring(
                                    0, img.lastIndexOf('.')).replace(/_/g,
                                    ' '));

                            if (dropTarget != null && dropTarget.parentNode
                            ...
                            var doImport = mxUtils.bind(this,
                                function (theData, theMimeType) {
                                  if (theData != null && theMimeType
                                      == 'application/pdf') {
                                    var xml = Editor.extractGraphModelFromPdf(
                                        theData);
                                  ...
                                  if (theData != null) //Try to parse the file as xml (can be a library or mxfile). Otherwise, an error will be shown
                                  {
                                    ...
                                    } else if (doc.documentElement.nodeName
                                        == 'mxfile') {
                                      try {
                                        var pages = doc.documentElement.getElementsByTagName(
                                            'diagram');

                                        for (var i = 0; i < pages.length; i++) {
                                          var cells = this.stringToCells(
                                              Editor.getDiagramNodeXml(
                                                  pages[i]));
                                          var size = this.editor.graph.getBoundingBoxFromGeometry(
                                              cells);
                                          addCells(cells,
                                              new mxRectangle(0, 0, size.width,
                                                  size.height), evt);
                                        }
                                        ...
                                        if (window.console != null) {
                                          console.log('error in drop handler:',
                                              e);
                                        }
                                      }
                                    }
                                  ...
                                  if (dropTarget != null
                                      ...
                                      && images.length > 0) {
                                    dropTarget.parentNode.removeChild(
                                        dropTarget);
                                    dropTarget = null;
                                  }
                                });
                            ...
                            if (file != null && img != null
                              ...
                              this.importVisio(file, function (xml) {
                                ...
                                && this.isRemoteFileFormat(data, img) && file
                                != null) {
  ...
  EditorUi.prototype.showImageDialog = function (title, value, fn,
      ignoreExisting, convertDataUri, withCrop, initClipPath) {
    // KNOWN: IE+FF don't return keyboard focus after image dialog (calling focus doesn't help)
    var dlg = new ImageDialog(this, title, value, fn, ignoreExisting,
        convertDataUri, withCrop, initClipPath);
    this.showDialog(dlg.container, (Graph.fileSupport) ? 480 : 360,
        (Graph.fileSupport) ? 200 : 90, true, true);
    dlg.init();
  };
   ...
   * Overrides image dialog to add image search and Google+.
   */
  EditorUi.prototype.showLocalStorageDialog = function (title, key, buttons,
      elt, helpLink, applyFn) {
    ...
    var dlg = new TextareaDialog(this, title, (value != null) ?
        ...
        }), null, mxResources.get('close'), null, null, null, true, null, null,
        helpLink, buttons, elt);
  ...
  EditorUi.prototype.showBackgroundImageDialog = function (apply, img, color,
      showColor) {
    apply = (apply != null) ? apply : mxUtils.bind(this,
        function (image, failed, color, shadowVisible) {
          if (!failed) {
            var change = new ChangePageSetup(this, (showColor) ? color : null,
                image);
   ...
   * Hides the current menu.
   */
  EditorUi.prototype.showLibraryDialog = function (name, sidebar, images, file,
      mode) {
    var dlg = new LibraryDialog(this, name, sidebar, images, file, mode);

    this.showDialog(dlg.container, 640, 440, true, false,
        mxUtils.bind(this, function (cancel) {
          if (cancel && this.getCurrentFile() == null && urlParams['embed']
              != '1') {
            this.showSplash();
          }
        }));
  ...
  EditorUi.prototype.createFormat = function (container) {
    ...
    this.editor.graph.addListener('viewStateChanged',
        mxUtils.bind(this, function (evt) {
  ...
  EditorUi.prototype.handleError = function (resp, title, fn, invokeFnOnClose,
      notFoundMessage, fileHash, disableLogging) {
    var resume = (this.spinner != null && this.spinner.pause != null)
        ? this.spinner.pause() : function () {
        };
    var e = (resp != null && resp.error != null) ? resp.error : resp;

    // Logs errors and writes stack to console
    if (resp != null && (urlParams['test'] == '1' || resp.stack != null)
        && resp.message != null) {
      try {
        if (!disableLogging) {
    ...
    if (e != null || title != null) {
      ...
      if (e != null) {
        ...
        if (e.code == 404 || e.status == 404 || e.code == 403) {
          ...
          var id = (notFoundMessage != null) ? null : ((fileHash != null)
          ...
          if (id != null && (id.substring(0, 2) == '#G' ||
              ...
              ((resp != null && resp.error != null && ((resp.error.errors
                          != null &&
                          resp.error.errors.length > 0 && resp.error.errors[0].reason
                          == 'fileAccess') ||
                      (resp.error.data != null && resp.error.data.length > 0 &&
                          resp.error.data[0].reason == 'fileAccess'))) ||
                  e.code == 404 || e.status == 404)) {
            id = (id.substring(0, 2) == '#U') ? id.substring(45,
                id.lastIndexOf('%26ex')) : id.substring(2);

            // Special case where the button must have a different label and function
            this.showError(title, msg, mxResources.get('openInNewWindow'),
                mxUtils.bind(this, function () {
                  this.editor.graph.openLink(
                      'https://drive.google.com/open?id=' + id);
                  this.handleError(resp, title, fn, invokeFnOnClose,
                      notFoundMessage)
                }), retry, mxResources.get('changeUser'),
                mxUtils.bind(this, function () {
                  ...
                  mxEvent.addListener(usersSelect, 'change',
                      mxUtils.bind(this, function () {
                        ...
                        this.drive.authorize(existingAccount,
                            mxUtils.bind(this, function () {
                              if (!existingAccount) {
                  ...
                  var dlg = new CustomDialog(this, div,
                      mxUtils.bind(this, function () {
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.confirm = function (msg, okFn, cancelFn, okLabel,
      cancelLabel, closable) {
    msg = (msg != null) ? msg : '';
    var resume = (this.spinner != null && this.spinner.pause != null)
        ? this.spinner.pause() : function () {
        };
   ...
   */
  EditorUi.prototype.showBanner = function (id, text, onclick,
      doNotShowAgainOnClose, small, positionCss, t1, t2, to) {
    var result = false;

    if (!this.bannerShowing && !this['hideBanner' + id] &&
        (!isLocalStorage || mxSettings.settings == null ||
            mxSettings.settings['close' + id] == null)) {
      positionCss = (positionCss != null) ? positionCss
          : 'bottom:10px;left:50%;';
      ...
      banner.style.cssText = 'position:absolute;' + positionCss
      ...
      mxUtils.setPrefixedStyle(banner.style, 'transition',
          'all ' + delay + 'ms ease');
      banner.className = 'geBtn gePrimaryBtn' + ((small) ? ' geSmallBanner'
          : '');

      if (!Editor.isDarkMode()) {
        mxUtils.setPrefixedStyle(banner.style, 'box-shadow',
            '1px 1px 2px 0px #ddd');
      }
      ...
      if (!small) {
        ...
        img.setAttribute('title', mxResources.get(
            (doNotShowAgainOnClose) ? 'doNotShowAgain' : 'close'));
  ...
  EditorUi.prototype.createImageDataUri = function (canvas, xml, format, dpi) {
    ...
    if (data != null && data.length > 6) {
      if (xml != null) {
        data = Editor.writeGraphModelToPng(data, 'tEXt', 'mxfile',
  ...
  EditorUi.prototype.saveCanvas = function (canvas, xml, format, ignorePageName,
    ...
    this.saveData(filename, ext, data.substring(data.lastIndexOf(',') + 1),
        'image/' + format, true);
  };
  ...
  EditorUi.prototype.isLocalFileSave = function () {
    return ((urlParams['save'] != 'remote' && (mxClient.IS_IE ||
                (typeof window.Blob !== 'undefined' && typeof window.URL
                    !== 'undefined')) &&
  ...
  EditorUi.prototype.showTextDialog = function (title, text) {
    var dlg = new TextareaDialog(this, title, text, null, null,
        mxResources.get('close'));
    this.showDialog(dlg.container, 620, 460, true, true, null, null, null, null,
        true);
    dlg.init();
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.doSaveLocalFile = function (data, filename, mimeType,
      base64Encoded, format, defaultExtension) {
    ...
    if (mimeType == 'text/xml' &&
      ...
      defaultExtension = (defaultExtension != null) ? defaultExtension
          : 'drawio';
    ...
    // Older versions of IE (binary not supported)
      ...
      if (!navigator.standalone && mimeType != null && mimeType.substring(0, 6)
          == 'image/') {
      ...
      if (useDownload || this.isOffline()) {
        ...
        var req = this.createEchoRequest(data, filename, mimeType,
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.createEchoRequest = function (data, filename, mimeType,
      base64Encoded, format, base64Response) {
    var param = (typeof (pako) === 'undefined' || true) ? 'xml='
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.saveLocalFile = function (data, filename, mimeType,
      base64Encoded, format, allowBrowser, allowTab, defaultExtension) {
    allowBrowser = (allowBrowser != null) ? allowBrowser : false;
    allowTab = (allowTab != null) ? allowTab : (format != 'vsdx')
        && (!mxClient.IS_IOS || !navigator.standalone);

    var saveFunction = mxUtils.bind(this,
          ...
          try {
            ...
            if (mode == '_blank') {
              if (mimeType != null && mimeType.substring(0, 6) == 'image/') {
                this.openInNewWindow(data, mimeType, base64Encoded);
              } else if (mimeType != null && mimeType.substring(0, 9)
                  == 'text/html') {
              ...
              var saveFile = mxUtils.bind(this, function (folderId) {
                try {
                  this.exportFile(data, newTitle, mimeType, base64Encoded, mode,
                      folderId);
                } catch (e) {
                  this.handleError(e);
                }
    ...
    if (urlParams['save-dialog'] != '0') {
      ...
      var dlg = new SaveDialog(this, filename,
      ...
      this.showDialog(dlg.container, 420, 110, true, false,
          mxUtils.bind(this, function () {
            this.hideDialog();
          }));
      ...
      var dlg = new CreateDialog(this, filename, saveFunction,
          mxUtils.bind(this, function () {
            this.hideDialog();
          }), mxResources.get('saveAs'), mxResources.get('download'), false,
          allowBrowser, allowTab,
          null, count > 1, rowLimit, data, mimeType, base64Encoded);
      var height = (this.isServices(count)) ? ((count > rowLimit) ? 390 : 280)
          : 160;
   ...
   *
   */
  EditorUi.prototype.openInNewWindow = function (data, mimeType,
      base64Encoded) {
    var win = window.open('about:blank');
    ...
    if (win == null || win.document == null) {
      ...
      if (mimeType == 'image/svg+xml' && !mxClient.IS_SVG) {
        win.document.write('<html><pre>' + mxUtils.htmlEntities(data, false)
            + '</pre></html>');
        win.document.close();
      } else {
        if (mimeType == 'image/svg+xml' && !base64Encoded) {
          ...
          var temp = (base64Encoded) ? data : btoa(
  ...
  EditorUi.prototype.addChromelessToolbarItems = function (addButton) {
    if (urlParams['tags'] != null) {
      ...
      var tagsButton = addButton(mxUtils.bind(this, function (evt) {
        if (this.tagsComponent == null) {
          ...
          mxUtils.setPrefixedStyle(this.tagsComponent.div.style, 'borderRadius',
              '5px');
        ...
        if (this.tagsDialog != null) {
          ...
          mxEvent.addListener(this.tagsDialog, 'mouseleave',
              mxUtils.bind(this, function () {
                if (this.tagsDialog != null) {
                  this.tagsDialog.parentNode.removeChild(this.tagsDialog);
                  this.tagsDialog = null;
          ...
          this.tagsDialog.style.bottom = parseInt(
    ...
    this.editor.addListener('layersDialogShown',
        mxUtils.bind(this, function () {
          if (this.tagsDialog != null) {
            this.tagsDialog.parentNode.removeChild(this.tagsDialog);
            this.tagsDialog = null;
    ...
    mxEvent.addListener(this.editor.graph.container, 'click',
        mxUtils.bind(this, function () {
          if (this.tagsDialog != null) {
            this.tagsDialog.parentNode.removeChild(this.tagsDialog);
            this.tagsDialog = null;
    ...
    if (this.isExportToCanvas() && this.isChromelessImageExportEnabled()) {
      ...
      var exportButton = addButton(mxUtils.bind(this, function (evt) {
        var clickHandler = mxUtils.bind(this, function () {
          mxEvent.removeListener(this.editor.graph.container, 'click',
              clickHandler);
        ...
        if (this.exportDialog != null) {
          ...
          mxUtils.setPrefixedStyle(this.exportDialog.style, 'borderRadius',
              '5px');
          ...
          this.exportDialog.style.bottom = parseInt(
                  this.chromelessToolbar.style.bottom) +
              this.chromelessToolbar.offsetHeight + 4 + 'px';
          ...
          this.editor.exportToCanvas(mxUtils.bind(this, function (canvas) {
                ...
                mxEvent.addListener(img, 'click', mxUtils.bind(this, function () {
                  this.openInNewWindow(data.substring(data.indexOf(',') + 1),
                      'image/png', true);
                  clickHandler.apply(this, arguments);
                }));
              }), null, this.thumbImageCache, null,
              mxUtils.bind(this, function (e) {
                spinner.stop();

                if (this.exportDialog != null && this.exportDialog.parentNode
                    != null) {
                  this.exportDialog.parentNode.removeChild(this.exportDialog);
                  this.exportDialog = null;
                }
  ...
  EditorUi.prototype.saveData = function (filename, format, data, mime,
    ...
    if (this.isLocalFileSave()) {
      ...
      this.saveRequest(filename, format,
          mxUtils.bind(this, function (newTitle, base64) {
            return this.createEchoRequest(data, newTitle, mime, base64Encoded,
                format, base64);
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.saveRequest = function (filename, format, fn, data,
      base64Encoded, mimeType, allowTab) {
    allowTab = (allowTab != null) ? allowTab : !mxClient.IS_IOS
        || !navigator.standalone;

    var saveFunction = mxUtils.bind(this,
        function (newTitle, mode, input, folderId) {
          if (mode == '_blank' || newTitle != null && newTitle.length > 0) {
            var base64 = (mode == App.MODE_DEVICE || mode == 'download' || mode
                == null || mode == '_blank') ? '0' : '1';
            var xhr = fn((mode == '_blank') ? null : newTitle, base64);

            if (xhr != null) {
              if (mode == App.MODE_DEVICE || mode == 'download' || mode
                  == '_blank') {
                ...
                var doSave = mxUtils.bind(this, function (folderId) {
                  ...
                  if (data != null) {
                    try {
                      this.exportFile(data, newTitle, mimeType, true, mode,
                          folderId);
                    } catch (e) {
                      this.handleError(e);
                    }
                    ...
                    xhr.send(mxUtils.bind(this, function () {
                      ...
                      if (xhr.getStatus() >= 200 && xhr.getStatus() <= 299) {
                        try {
                          this.exportFile(xhr.getText(), newTitle, mimeType,
                              true, mode, folderId);
                        } catch (e) {
                          this.handleError(e);
                        }
   ...
   * Hook for subclassers.
   */
  EditorUi.prototype.exportFile = function (data, filename, mimeType,
      base64Encoded, mode, folderId) {
    // do nothing
  };
   ...
   *
   */
  EditorUi.prototype.exportSvg = function (scale, transparentBackground,
      ignoreSelection, addShadow,
      editable, embedImages, border, noCrop, currentPage, linkTarget, theme,
      exportType,
      embedFonts, saveFn) {
    if (this.spinner.spin(document.body, mxResources.get('export'))) {
      try {
        ...
        if (bg == null && transparentBackground == false) {
          bg = (theme == 'dark' && !Editor.enableSvgDarkMode) ? Editor.darkColor
              : '#ffffff';
        }
        ...
        var filename = this.getBaseFilename() + ((editable) ? '.drawio' : '')
            + '.svg';
   ...
   *
   */
  EditorUi.prototype.addRadiobox = function (div, radioGroupName, label,
      checked, disabled, disableNewline, visible) {
    return this.addCheckbox(div, label, checked, disabled, disableNewline,
        visible, true, radioGroupName);
  };
  ...
  EditorUi.prototype.addCheckbox = function (div, label, checked, disabled,
      disableNewline, visible, asRadio, radioGroupName) {
  ...
  EditorUi.prototype.addEditButton = function (div, lightbox) {
    var edit = this.addCheckbox(div, mxResources.get('edit') + ':', true, null,
        true);
    ...
    mxEvent.addListener(editSelect, 'change', mxUtils.bind(this, function () {
      if (editSelect.value == 'custom') {
        var dlg2 = new FilenameDialog(this, editUrl, mxResources.get('ok'),
            function (value) {
              if (value != null) {
                editUrl = value;
              } else {
    ...
    return {
      getLink: function () {
        return (edit.checked) ? ((editSelect.value === 'blank') ? '_blank'
            : editUrl) : null;
      },
  ...
  EditorUi.prototype.addLinkSection = function (div, showFrameOption) {
    ...
    linkButton.style.top = (mxClient.IS_IE || mxClient.IS_IE11
        || mxClient.IS_EDGE) ? '6px' : '1px';
   ...
   *
   */
  EditorUi.prototype.createUrlParameters = function (linkTarget, linkColor,
      allPages, lightbox, editLink, layers, params) {
    params = (params != null) ? params : [];

    if (lightbox) {
      if (EditorUi.lightboxHost != 'https://viewer.diagrams.net'
          || urlParams['dev'] == '1') {
   ...
   *
   */
  EditorUi.prototype.createLink = function (linkTarget, linkColor, allPages,
      lightbox, editLink, layers, url, ignoreFile, params, useOpenParameter) {
    params = this.createUrlParameters(linkTarget, linkColor, allPages, lightbox,
    ...
    if (addTitle && file != null && file.getTitle() != null && file.getTitle()
        != this.defaultFilename) {
   ...
   *
   */
  EditorUi.prototype.createHtml = function (publicUrl, zoomEnabled, initialZoom,
      linkTarget,
    ...
    var value = '<div class="mxgraph" style="' +
        ...
        '" data-mxgraph="' + mxUtils.htmlEntities(JSON.stringify(data))
        + '"></div>';

    var fetchParam = (publicUrl != null) ? '&fetch=' + encodeURIComponent(
        publicUrl) : '';
    var s2 = (fetchParam.length > 0) ? (((urlParams['dev'] == '1') ?
        'https://test.draw.io/embed2.js?dev=1' : EditorUi.lightboxHost
        + '/embed2.js?')) + fetchParam :
        (((urlParams['dev'] == '1')
            ? 'https://test.draw.io/js/viewer-static.min.js' :
            window.DRAWIO_VIEWER_URL ? window.DRAWIO_VIEWER_URL
   ...
   *
   */
  EditorUi.prototype.showHtmlDialog = function (btnLabel, helpLink, publicUrl,
      fn) {
    var div = document.createElement('div');
    ...
    if (publicUrl == null && file != null && file.constructor
        == window.DriveFile) {
    ...
    var allPages = allPages = this.addCheckbox(div, mxResources.get('allPages'),
        hasPages, !hasPages);
    ...
    var dlg = new CustomDialog(this, div, mxUtils.bind(this, function () {
      fn((publicUrlRadio.checked) ? publicUrl : null, zoom.checked,
          zoomInput.value, linkSection.getTarget(),
          linkSection.getColor(), fit.checked, allPages.checked, layers.checked,
          tags.checked,
          lightbox.checked,
   ...
   *
   */
  EditorUi.prototype.showPublishLinkDialog = function (title, hideShare, width,
      height, fn, showFrameOption, helpLink, footer) {
    var div = document.createElement('div');
    div.style.whiteSpace = 'nowrap';
    var graph = this.editor.graph;
    ...
    if (file != null && file.constructor == window.DriveFile && !hideShare) {
      ...
      var shareBtn = mxUtils.button(mxResources.get('share'),
          mxUtils.bind(this, function () {
            this.drive.showPermissions(file.getId());
          }));
        ...
        if (this.spinner.spin(document.body, mxResources.get('loading'))) {
          this.getPublicUrl(this.getCurrentFile(),
              mxUtils.bind(this, function (url) {
                ...
                var dlg = new ErrorDialog(this, null,
                    mxResources.get((url != null) ?
                        'diagramIsPublic' : 'diagramIsNotPublic'),
                    mxResources.get('ok'));
    ...
    if (file == null || file.constructor != window.DriveFile || hideShare) {
      allPages = this.addCheckbox(div, mxResources.get('allPages'), hasPages,
          !hasPages);
    }

    var lightbox = this.addCheckbox(div, mxResources.get('lightbox'), true,
        null, null, !showFrameOption);
   ...
   *
   */
  EditorUi.prototype.showRemoteExportDialog = function (btnLabel, helpLink,
      callback, hideInclude, showZoomBorder) {
    var div = document.createElement('div');
    div.style.whiteSpace = 'nowrap';

    var hd = document.createElement('h3');
    mxUtils.write(hd, mxResources.get('image'));
    hd.style.cssText = 'width:100%;text-align:center;margin-top:0px;margin-bottom:'
        + (showZoomBorder ? '10' : '4') + 'px';
    div.appendChild(hd);
    ...
    var selection = this.addCheckbox(div, mxResources.get('selectionOnly'),
        false,
        this.editor.graph.isSelectionEmpty());
    var include = (hideInclude) ? null : this.addCheckbox(div,
        mxResources.get('includeCopyOfMyDiagram'),
        Editor.defaultIncludeDiagram);

    var graph = this.editor.graph;
    var transparent = (hideInclude) ? null : this.addCheckbox(div,
    ...
    this.showDialog(dlg.container, 300,
        (showZoomBorder ? 25 : 0) + (hideInclude ? 125 : 210), true, true);
  };

  /**
   *
   */
  EditorUi.prototype.showExportDialog = function (title, embedOption, btnLabel,
      helpLink, callback,
      cropOption, defaultInclude, format, exportOption) {
    defaultInclude = (defaultInclude != null) ? defaultInclude
        : Editor.defaultIncludeDiagram;
    ...
    ;
    var transparent = this.addCheckbox(div,
        mxResources.get('transparentBackground'),
    ...
    var include = this.addCheckbox(div,
        mxResources.get('includeCopyOfMyDiagram'),
    ...
    if (this.getServiceName() == 'draw.io' && !this.isOffline()
        && !EditorUi.isElectronApp) {
      txtSettingsSelect.appendChild(lblToSvgOption);
    }

    mxEvent.addListener(txtSettingsSelect, 'change',
        mxUtils.bind(this, function () {
    ...
    this.showDialog(dlg.container, 340, height, true, true, null, null, null,
        null, true);
    zoomInput.focus();
   ...
   *
   */
  EditorUi.prototype.showEmbedImageDialog = function (fn, title, imageLabel,
      shadowEnabled, helpLink) {
    var div = document.createElement('div');
    div.style.whiteSpace = 'nowrap';
    var graph = this.editor.graph;
    ...
    var layers = this.addCheckbox(div, mxResources.get('layers'), hasLayers,
        !hasLayers);
    layers.style.marginLeft = edit.style.marginLeft;
   ...
   *
   */
  EditorUi.prototype.createEmbedImage = function (fit, shadow, retina, lightbox,
      edit, layers, fn, err) {
    ...
    function doUpdate(dataUri) {
      ...
      if (lightbox) {
        ...
        onclick = " onclick=\"(function(img){if(img.wnd!=null&&!img.wnd.closed){img.wnd.focus();}else{var r=function(evt){if(evt.data=='ready'&&evt.source==img.wnd){img.wnd.postMessage(decodeURIComponent("
            ...
            + EditorUi.lightboxHost + "/?client=1" +
            ((page != null) ? ("&page=" + page) : "") +
            ((edit) ? "&edit=_blank" : "") +
      ...
      if (retina) {
        atts = ' width="' + Math.round(bounds.width) + '" height="'
            + Math.round(bounds.height) + '"';
      }

      fn('<img src="' + dataUri + '"' + atts + ((css != '') ? ' style="' + css
          + '"' : '') + onclick + '/>');
    };
    ...
    if (this.isExportToCanvas()) {
      this.editor.exportToCanvas(mxUtils.bind(this, function (canvas) {
          ...
          }), null, true, (retina) ? 2 : 1, null, shadow, null, null,
          Editor.defaultBorder);
    } else {
   ...
   *
   */
  EditorUi.prototype.createEmbedSvg = function (fit, shadow, image, lightbox,
      edit, layers, fn) {
    ...
    if (node != null) {
      ...
      if (node.nodeName == 'diagram') {
        ...
        if (diagrams.length > 0) {
          ...
          graph.getGlobalVariable = function (name) {
            if (name == 'page') {
              return diagramNode.getAttribute('name') || mxResources.get(
                  'pageWithNumber', [1])
            } else if (name == 'pagenumber') {
              return 1;
            }
  ...
  EditorUi.prototype.getEmbeddedPng = function (success, error, optionalData,
    ...
    try {
      ...
      else if (darkTheme || (this.pages != null && this.currentPage
          != this.pages[0])) {
        graph = this.createTemporaryGraph((darkTheme) ?
            graph.getDefaultStylesheet() : graph.getStylesheet());
        var graphGetGlobalVariable = graph.getGlobalVariable;
   ...
   */
  EditorUi.prototype.getEmbeddedSvg = function (xml, graph, url, noHeader,
      callback, ignoreSelection,
...
//		}
   ...
   *
   */
  EditorUi.prototype.exportImage = function (scale, transparentBackground,
      ignoreSelection, addShadow,
      editable, border, noCrop, currentPage, format, grid, dpi, theme,
      exportType) {
        ...
        try {
          ...
          if (node != null && node.nodeName == 'mxfile' && this.pages != null) {
            ...
            if (diagrams.length == 1 && !addNewPage) {
              ...
              if (this.currentPage != null) {
                mapping[diagrams[0].getAttribute(
  ...
  EditorUi.prototype.updatePageLinks = function (mapping, pages) {
    for (var i = 0; i < pages.length; i++) {
      ...
      if (pages[i].viewState != null) {
        this.updateBackgroundPageLink(mapping,
  ...
  EditorUi.prototype.updateBackgroundPageLink = function (mapping, obj) {
    try {
      if (obj != null && Graph.isPageLink(obj.originalSrc)) {
        var newId = mapping[obj.originalSrc.substring(
            obj.originalSrc.indexOf(',') + 1)];
  ...
  EditorUi.prototype.isRemoteVisioFormat = function (filename) {
    return /(\.v(sd|dx))($|\?)/i.test(filename) || /(\.vs(s|x))($|\?)/i.test(
        filename);
  };
  ...
  EditorUi.prototype.importVisio = function (file, done, error, filename,
    ...
    this.createTimeout(null, mxUtils.bind(this, function (timeout) {
        ...
        if (this.doImportVisio) {
          ...
          if (remote) {
            if (VSD_CONVERT_URL != null && !this.isOffline()) {
              ...
              xhr.open('POST',
                  VSD_CONVERT_URL + (/(\.vss|\.vsx)$/.test(filename)
                      ? '?stencil=1' : ''));
              ...
              handleError({
                message: this.getServiceName() != 'draw.io' ? mxResources.get(
                        'vsdNoConfig') :
      ...
      if (!this.doImportVisio && !this.loadingExtensions && !this.isOffline(
        ...
        mxscript('js/extensions.min.js', delayed, null, null, null,
            handleError);
      } else {
        delayed();
      }
  ...
  EditorUi.prototype.exportVisio = function (currentPage) {
    if (this.spinner.spin(document.body, mxResources.get('loading'))) {
      ...
      this.createTimeout(null, mxUtils.bind(this, function (timeout) {
        ...
        if (typeof VsdxExport === 'undefined' && !this.loadingExtensions
            && !this.isOffline(true)) {
          this.loadingExtensions = true;
          mxscript('js/extensions.min.js', delayed, null, null, null,
              handleError);
          ...
          if (typeof window.LucidImporter !== 'undefined') {
            try {
              ...
              try {
                ...
                if (window.console != null && urlParams['test'] == '1') {
                  var args = [new Date().toISOString(), 'convertLucidChart',
                    obj];
   ...
   * Generates a Mermaid image.
   */
  EditorUi.prototype.generateOpenAiMermaidDiagram = function (prompt, success,
      error) {
    var maxRetries = 3;
    var retryCount = 0;
            ...
            if (timeout.isAlive()) {
              if (req.getStatus() >= 200 && req.getStatus() <= 299) {
                this.tryAndHandle(mxUtils.bind(this, function () {
                  ...
                  this.generateMermaidImage(result, null,
   ...
   * Generates a Mermaid image.
   */
  EditorUi.prototype.generateMermaidImage = function (data, config, success,
    ...
    var delayed = mxUtils.bind(this, function () {
      try {
        ...
        config = (config != null) ? config : mxUtils.clone(
            EditorUi.defaultMermaidConfig);
          ...
          try {
            ...
            if (mxClient.IS_IE || mxClient.IS_IE11) {
              svg = svg.replace(
                  ...
                  '').replace(/ (NS xml|\S*):space="preserve"/g,
                  ' xml:space="preserve"');
            }
            ...
            if (svgs.length > 0 && svgs[0].getAttribute('aria-roledescription')
                != 'error') {
   ...
   */
  EditorUi.prototype.generatePlantUmlImage = function (data, type, success,
      error) {
  ...
  EditorUi.prototype.insertTextAt = function (text, dx, dy, html, asImage, crop,
    ...
    if (text != null) {
      if (Graph.fileSupport && new XMLHttpRequest().upload
        ...
        if (this.isOffline()) {
          ...
          this.parseFileData(text.replace(/\s+/g, ' '),
              mxUtils.bind(this, function (xhr) {
      ...
      // Handles special case of data URI which requires async loading for finding size
        ...
        if (text.substring(0, 19) == 'data:image/svg+xml;') {
          try {
            ...
            if (text.substring(0, 26) == 'data:image/svg+xml;base64,') {
              ...
              xml = (window.atob && !mxClient.IS_SF) ? atob(xml)
        ...
        this.loadImage(text, mxUtils.bind(this, function (img) {
          if (text.substring(0, 5) == 'data:') {
            this.resizeImage(img, text,
                mxUtils.bind(this, function (data2, w2, h2) {
                  graph.setSelectionCell(
                      graph.insertVertex(null, null, '', graph.snap(dx),
                          graph.snap(dy),
                          w2, h2,
            ...
            var s = Math.min(1, Math.min(this.maxImageSize / img.width,
          ...
          try {
            cell = graph.insertVertex(graph.getDefaultParent(), null, text,
                graph.snap(dx), graph.snap(dy), 1, 1,
                'text;' + ((html) ? 'html=1;' : ''));
        ...
        if (this.isCompatibleString(text)) {
          ...
          if (this.isLucidChartData(text)) {
            ...
            try {
              ...
              if (this.maxTextWidth > 0 && cell.geometry.width
                  > this.maxTextWidth) {
  ...
  EditorUi.prototype.convertDataUri = function (uri) {
    ...
    if (uri.substring(0, 5) == 'data:') {
      ...
      if (semi > 0) {
        uri = uri.substring(0, semi) + uri.substring(
            uri.indexOf(',', semi + 1));
      }
    }
  ...
  EditorUi.prototype.importLocalFile = function (device, noSplash) {
    if (device && Graph.fileSupport) {
      ...
      window.openBrowserFile = mxUtils.bind(this,
          function (title, success, error) {
            StorageFile.getFileContent(this, title, success, error);
          });

      window.deleteBrowserFile = mxUtils.bind(this,
          function (title, success, error) {
      ...
      window.openFile.setConsumer(mxUtils.bind(this, function (xml, filename) {
        if (filename != null && Graph.fileSupport
      ...
      this.showDialog(new OpenDialog(this).container,
  ...
  EditorUi.prototype.importZipFile = function (file, success, onerror) {
          ...
          if (mxUtils.isEmptyObject(zip.files)) {
            ...
            if (gliffyLatestVer.version > 0) {
              gliffyLatestVer.zipEntry.async("string").then(function (data) {
                if (new XMLHttpRequest().upload && ui.isRemoteFileFormat(data,
                    file.name)) {
                  if (ui.isOffline()) {
                    ui.showError(mxResources.get('error'),
                        mxResources.get('notInOffline'), null, onerror);
                  } else {
    ...
    if (typeof JSZip === 'undefined' && !this.loadingExtensions
        && !this.isOffline(true)) {
      this.loadingExtensions = true;
      mxscript('js/extensions.min.js', delayed,
          null, null, null, onerror);
   ...
   * Imports the given XML into the existing diagram.
   */
  EditorUi.prototype.importFile = function (data, mimeType, dx, dy, w, h,
      filename,
    ...
    if (mimeType.substring(0, 5) == 'image') {
      ...
      if (mimeType.substring(0, 9) == 'image/png') {
        var xml = (ignoreEmbeddedXml) ? null : this.extractGraphModelFromPng(
            data);
      ...
      if (!containsModel) {
        ...
        if (semi > 0) {
          data = data.substring(0, semi) + data.substring(
              data.indexOf(',', semi + 1));
        }
    ...
    } else if (new XMLHttpRequest().upload && this.isRemoteFileFormat(data,
        filename)) {
      if (this.isOffline()) {
        this.showError(mxResources.get('error'),
            mxResources.get('notInOffline'));
    ...
    } else if (!/(\.v(sd|dx))($|\?)/i.test(filename)
   ...
   *
   */
  EditorUi.prototype.importFiles = function (files, x, y, maxSize, fn, resultFn,
      filterFn, barrierFn,
    ...
    var doImportFiles = mxUtils.bind(this, function () {
      ...
      fn = (fn != null) ? fn : mxUtils.bind(this,
          function (data, mimeType, x, y, w, h, filename, done, file) {
            try {
              if (data != null && data.substring(0, 10) == '<mxlibrary') {
                ...
                return null;
              } else if (this.getServiceName() != 'atlassian'
                  && urlParams['embed'] != '1' &&
      ...
      resultFn = (resultFn != null) ? resultFn : mxUtils.bind(this,
          function (cells) {
        ...
        for (var i = 0; i < count; i++) {
          (mxUtils.bind(this, function (index) {
            ...
            if (file != null) {
                  ...
                  try {
                    if (file.type.substring(0, 6) == 'image/') {
                      if (file.type.substring(0, 9) == 'image/svg') {
                        ...
                        if (svgs.length > 0) {
                          var svgRoot = svgs[0];
                          var cont = (ignoreEmbeddedXml) ? null
                              : svgRoot.getAttribute('content');

                          if (cont != null && cont.charAt(0) != '<'
                              && cont.charAt(0) != '%') {
                            cont = unescape(
                                (window.atob) ? atob(cont) : Base64.decode(cont,
                                    true));
                          }
                          ...
                          if (cont != null && (cont.substring(0, 8)
                              === '<mxfile ' ||
                              cont.substring(0, 14) === '<mxGraphModel ')) {
                            barrier(index, mxUtils.bind(this, function () {
                              return fn(cont, 'text/xml', x + index * gs,
                                  y + index * gs, 0, 0, file.name);
                            }));
                          } else {
                              ...
                              try {
                                ...
                                if (root != null) {
                                  ...
                                  if (svgs.length > 0) {
                                    ...
                                    var cells = fn(data, file.type,
                                        x + index * gs, y + index * gs,
                                        Math.max(
                                            1, Math.round(w * s)),
                        ...
                        if (file.type == 'image/png') {
                          var xml = (ignoreEmbeddedXml) ? null
                          ...
                          if (xml != null && xml.length > 0) {
                            ...
                            barrier(index, mxUtils.bind(this, function () {
                              return fn(xml, 'text/xml', x + index * gs,
                                  y + index * gs,
                          ...
                          if (mxClient.IS_CHROMEAPP) {
                            ...
                            this.loadImage(e.target.result,
                                mxUtils.bind(this, function (img) {
                                  this.resizeImage(img, e.target.result,
                                      mxUtils.bind(this,
                                          ...
                                          }), resizeImages, maxSize,
                                      resampleThreshold, file.size);
                                }), mxUtils.bind(this, function () {
                                  this.handleError({
                                    message: mxResources.get(
                                        'invalidOrMissingFile')
                      ...
                      fn(data, file.type, x + index * gs, y + index * gs, 240,
                          160, file.name, function (cells) {
              ...
              if (/(\.v(dx|sdx?))($|\?)/i.test(file.name)
                  || /(\.vs(x|sx?))($|\?)/i.test(file.name)) {
                fn(null, file.type, x + index * gs, y + index * gs, 240, 160,
                    file.name, function (cells) {
                      barrier(index, function () {
                        return cells;
                      });
                    }, file);
              } else if (file.type.substring(0, 5) == 'image' || file.type
                  == 'application/pdf') {
  ...
  EditorUi.prototype.confirmImageResize = function (fn, force) {
    ...
    var resizeImages = (isLocalStorage || mxClient.IS_CHROMEAPP)
        ? mxSettings.getResizeImages() : null;
    ...
    if (resizeImages != null && !force) {
      ...
      this.showDialog(
          new ConfirmDialog(this, mxResources.get('resizeLargeImages'),
              function (remember) {
  ...
  EditorUi.prototype.parseFileData = function (data, fn, filename) {
    ...
    xhr.send('format=xml&filename=' + encodeURIComponent(filename) + '&data='
        + encodeURIComponent(data));
   ...
   */
  EditorUi.prototype.resizeImage = function (img, data, fn, enabled, maxSize,
      thresh, fileSize) {
    maxSize = (maxSize != null) ? maxSize : this.maxImageSize;
    ...
    if (enabled && this.isResampleImageSize(
        (fileSize != null) ? fileSize : data.length, thresh)) {
      try {
    ...
    if (enabled && originalData != data && maxSize > this.maxImageSize / 2
  ...
  EditorUi.prototype.getDefaultSketchMode = function () {
    ...
    var roughParam = (urlParams['rough'] != null) ? urlParams['rough']
        : defaultValue;
    ...
    if (Editor.isSettingsEnabled()) {
      this.doSetSketchMode(
          (mxSettings.settings.sketchMode != null && urlParams['rough'] == null
              &&
              urlParams['sketch'] == null) ? mxSettings.settings.sketchMode
  ...
  EditorUi.prototype.init = function () {
    mxStencilRegistry.allowEval = mxStencilRegistry.allowEval
        && !this.isOfflineApp();
    ...
    graph.cellEditor.editPlantUmlData = function (cell, trigger, data) {
      ...
      var dlg = new TextareaDialog(ui, mxResources.get('plantUml') + ':',
          obj.data, function (text) {
            if (text != null) {
              if (ui.spinner.spin(document.body,
                  mxResources.get('inserting'))) {
                ui.generatePlantUmlImage(text, obj.format,
                    function (data, w, h) {
                      ui.spinner.stop();
      ...
      var dlg = new TextareaDialog(ui, mxResources.get('mermaid') + ':',
          obj.data, function (text) {
            if (text != null) {
              if (ui.spinner.spin(document.body,
                  mxResources.get('inserting'))) {
                ui.generateMermaidImage(text, obj.config,
                    function (data, w, h) {
                      ui.spinner.stop();
    ...
    graph.parseBackgroundImage = function (json) {
      ...
      if (result != null && result.src != null && Graph.isPageLink(
          result.src)) {
    ...
    this.editor.addListener('pagesPatched',
        mxUtils.bind(this, function (sender, evt) {
          var ref = (graph.backgroundImage != null)
              ? graph.backgroundImage.originalSrc : null;
              ...
              for (var i = 0; i < patches.length; i++) {
                if ((patches[i][EditorUi.DIFF_UPDATE] != null &&
                    ...
                    (patches[i][EditorUi.DIFF_REMOVE] != null &&
                        mxUtils.indexOf(patches[i][EditorUi.DIFF_REMOVE], id)
                        >= 0)) {
                  graph.refreshBackgroundImage();
    ...
    if (mxClient.IS_SVG) {
      ...
      this.editor.graph.addSvgShadow(graph.view.canvas.ownerSVGElement, null,
          true);
    }
          ...
          if (!this.isShowStyleItems()) {
            if (graph.getSelectionCount() == 1 && !graph.isCellLocked(cell) &&
              ...
              if (graph.getModel().isEdge(cell)) {
                ...
                if (geo != null && geo.points != null && geo.points.length
                    > 0) {
    ...
    graph.labelLinkClicked = function (state, elt, evt) {
      ...
      if (href != null && graph.isCustomLink(href) &&
        ...
        if (!graph.isEnabled() || (state != null && graph.isCellLocked(
            state.cell))) {
      ...
      graph.addListener(mxEvent.EDITING_STARTED,
          mxUtils.bind(this, function (evt) {
            ...
            if (textElt != null) {
              ...
              mxEvent.addListener(textElt, 'dragover',
                  mxUtils.bind(this, function (evt) {
                    // IE 10 does not implement pointer-events so it can't have a drop highlight
                    if (dropElt == null && (!mxClient.IS_IE
              ...
              mxEvent.addListener(textElt, 'drop',
                  mxUtils.bind(this, function (evt) {
                    if (dropElt != null) {
                      dropElt.parentNode.removeChild(dropElt);
                      dropElt = null;
                    ...
                    if (evt.dataTransfer.files.length > 0) {
                        ...
                        this.loadImage(decodeURIComponent(uri),
                            mxUtils.bind(this, function (img) {
                              ...
                              var s = Math.min(1,
                                  Math.min(maxSize / Math.max(1, w)),
                                  maxSize / Math.max(1, h));
                              graph.insertImage(decodeURIComponent(uri), w * s,
                                  h * s);
                            }));
                      } else {
                      ...
                      if (mxUtils.indexOf(evt.dataTransfer.types, 'text/html')
                          >= 0) {
                        document.execCommand('insertHTML', false,
    ...
    if (urlParams['styledev'] == '1') {
      ...
      if (footer != null) {
        ...
        mxEvent.addListener(this.styleInput, 'change',
            mxUtils.bind(this, function () {
              this.editor.graph.getModel().setStyle(
                  this.editor.graph.getSelectionCell(), this.styleInput.value);
            }));
    ...
    if (Graph.fileSupport && (!this.editor.chromeless
      ...
      mxEvent.addListener(graph.container, 'dragover',
          mxUtils.bind(this, function (evt) {
            // IE 10 does not implement pointer-events so it can't have a drop highlight
      ...
      mxEvent.addListener(graph.container, 'drop',
          mxUtils.bind(this, function (evt) {
            if (dropElt != null) {
              dropElt.parentNode.removeChild(dropElt);
              dropElt = null;
            ...
            if (graph.isEnabled()) {
              ...
              if (files.length > 0) {
                if (urlParams['embed'] != '1' && mxEvent.isShiftDown(evt)) {
                  ...
                  this.importFiles(files, x, y, this.maxImageSize, null, null,
                      null,
                ...
                var uri = (mxUtils.indexOf(evt.dataTransfer.types,
                    'text/uri-list') >= 0) ?
                ...
                if (data != null) {
                ...
                } else if (mxUtils.indexOf(evt.dataTransfer.types, 'text/html')
                    >= 0) {
                  ...
                  var doInsert = mxUtils.bind(this, function () {
                    graph.setSelectionCells(this.insertTextAt(html, x, y, true,
                        asImage, null, resizeImages,
                        mxEvent.isControlDown(evt)));
                  });

                  if (asImage && html != null && html.length
                  ...
                  this.loadImage(decodeURIComponent(uri),
                      mxUtils.bind(this, function (img) {
                        ...
                        var s = Math.min(1, Math.min(maxSize / Math.max(1, w)),
                            maxSize / Math.max(1, h));

                        graph.setSelectionCell(
                            graph.insertVertex(null, null, '', x, y, w * s,
                                h * s,
                                'shape=image;verticalLabelPosition=bottom;labelBackgroundColor=default;'
                                +
                                'verticalAlign=top;aspect=fixed;imageAspect=0;image='
                        ...
                        graph.setSelectionCells(
                            this.insertTextAt(uri, x, y, true));
                      }));
                } else if (mxUtils.indexOf(evt.dataTransfer.types, 'text/plain')
                    >= 0) {
                  graph.setSelectionCells(
                      this.insertTextAt(evt.dataTransfer.getData('text/plain'),
                          x, y, true));
                }
              }
            }
    ...
    mxWindow.prototype.fit = function () {
      if (!Editor.inlineFullscreen && ui.embedViewport != null) {
        ...
        this.div.style.left = Math.max(ui.embedViewport.x,
            Math.min(left, right - width)) + 'px';
        this.div.style.top = Math.max(ui.embedViewport.y,
            Math.min(top, bottom - height)) + 'px';
        this.div.style.height = Math.min(ui.embedViewport.height,
            parseInt(this.div.style.height)) + 'px';
        this.div.style.width = Math.min(ui.embedViewport.width,
            parseInt(this.div.style.width)) + 'px';
      } else {
    ...
    if (Editor.currentTheme != 'atlas') {
      ...
      } else if (Editor.isSettingsEnabled() && mxSettings.settings.darkMode
          === true) {
        darkMode = true;
      }
    }
  ...
  EditorUi.prototype.windowResized = function () {
    if (Editor.currentTheme == 'simple') {
      ...
      if (this.lastWindowWidth != null && this.lastWindowWidth >= limit && iw
          < limit) {
        if (this.isFormatPanelVisible()) {
          this.toggleFormatPanel(false);
        }
      } else if (this.lastWindowWidth != null && this.lastWindowWidth < limit
          && iw >= limit) {
        if (!this.isFormatPanelVisible()) {
  ...
  EditorUi.prototype.initializeInlineEmbedMode = function () {
    ...
    mxEvent.addGestureListeners(this.diagramContainer.parentNode,
        mxUtils.bind(this, function (evt) {
    ...
    mxEvent.addGestureListeners(document.body, null,
        mxUtils.bind(this, function (evt) {
          var changed = false;
  ...
  EditorUi.prototype.installImagePasteHandler = function () {
    if (!mxClient.IS_IE) {
      ...
      graph.container.addEventListener('paste',
          mxUtils.bind(this, function (evt) {
            if (!mxEvent.isConsumed(evt)) {
              try {
                ...
                if (!containsText) {
                  ...
                  for (index in items) {
                    ...
                    if (item.kind === 'file') {
                      if (graph.isEditing()) {
                        this.importFiles([item.getAsFile()], 0, 0,
                            this.maxImageSize,
                            function (data, mimeType, x, y, w, h) {
                              // Inserts image into current text box
                              graph.insertImage(data, w, h);
                        ...
                        this.importFiles([item.getAsFile()], pt.x, pt.y,
                            this.maxImageSize);
                        mxEvent.consume(evt);
                      }
  ...
  EditorUi.prototype.installNativeClipboardHandler = function () {
    ...
    mxEvent.addListener(document, 'keydown', mxUtils.bind(this, function (evt) {
      ...
      if (graph.container != null && graph.isEnabled() && !graph.isMouseDown
          && !graph.isEditing() &&
          this.dialog == null && source.nodeName != 'INPUT' && source.nodeName
          != 'TEXTAREA') {
        if (evt.keyCode == 224 /* FF */ || (!mxClient.IS_MAC && evt.keyCode
                == 17 /* Control */) ||
            (mxClient.IS_MAC && (evt.keyCode == 91 || evt.keyCode
                == 93) /* Left/Right Meta */)) {
    ...
    mxEvent.addListener(document, 'keyup', mxUtils.bind(this, function (evt) {
      ...
      window.setTimeout(mxUtils.bind(this, function () {
        if (restoreFocus && (keyCode == 224 /* FF */ || keyCode == 17 /* Control */
          ...
          if (!graph.isEditing() && this.dialog == null && graph.container
              != null) {
      ...
      if (Editor.currentTheme == 'sketch') {
        ...
        if (!visible && elt != null) {
          ...
          if (title == mxResources.get(key) + '...') {
            this.statusContainer.innerHTML = '<div><img title="'
        ...
        this.statusContainer.style.display = 'inline-flex';
        this.statusContainer.style.display = (this.statusContainer.clientWidth
            == 0)
            ? 'none' : 'inline-flex';
      } else {
        this.statusContainer.style.display = 'inline-flex';
  ...
  EditorUi.prototype.createWrapperForTheme = function (value) {
    ...
    } else if (this.sketchWrapperElt != null && this.sketchWrapperElt.parentNode
        != null) {
      this.tabContainer.parentNode.insertBefore(this.diagramContainer,
          this.tabContainer);
    ...
    if (value == 'simple' || value == 'sketch') {
      if (this.sketchMainMenuElt == null) {
        ...
        if (value == 'simple') {
          ...
          this.sketchMainMenuElt.appendChild(
              this.createMenuItem('delete', Editor.trashImage));
          this.sketchMainMenuElt.appendChild(
              this.createMenuItem('undo', Editor.undoImage));
          this.sketchMainMenuElt.appendChild(
              this.createMenuItem('redo', Editor.redoImage));
      ...
      if (this.sketchFooterMenuElt == null) {
        ...
        if (value != 'simple') {
          ...
          var pagesVisibleChanged = mxUtils.bind(this, function () {
            pageMenu.style.display = (this.isPageMenuVisible()) ? 'inline-block'
                : 'none';
          });
        ...
        var elt = this.createMenu('viewZoom', null,
        ...
        (mxUtils.bind(this, function (elt) {
          ...
          var updateZoom = mxUtils.bind(this, function (sender, evt, f) {
            ...
            elt.innerText = '';
            mxUtils.write(elt,
                Math.round(this.editor.graph.view.scale * 100 * f) + '%');
          });
          ...
          // Zoom Preview
          this.editor.graph.addListener('zoomPreview',
              mxUtils.bind(this, function (sender, evt) {
        ...
        if (urlParams['embedInline'] == '1') {
          var fullscreenElt = this.createMenuItem('fullscreen',
  ...
  EditorUi.prototype.createPickerMenuForTheme = function (value) {
    if (value == 'simple' || value == 'sketch') {
      if (this.sketchPickerMenuElt == null) {
        ...
        var picker = this.sketchPickerMenuElt;
        mxUtils.setPrefixedStyle(picker.style, 'transition',
        ...
        mxEvent.addListener(shapesElt, 'click',
            mxUtils.bind(this, function (evt) {
              if (this.isShapePickerVisible()) {
                ...
                this.showShapePicker(Math.max(
                        this.diagramContainer.scrollLeft + Math.max(24, off.x)),
                    this.diagramContainer.scrollTop + off.y, null, null, null,
                    null,
                    mxUtils.bind(this, function (cells) {
                      return graph.getCenterInsertPoint(
        ...
        var initPicker = mxUtils.bind(this, function (force) {
          if (force || document.body.contains(picker)) {
            ...
            function addElt(elt, title, cursor, key, kx, ky) {
              ...
              elt.style.margin = (value == 'simple') ? '0px'
                  : '8px 0px 8px 2px';
              elt.style.display = (value == 'simple') ? 'inline-block'
                  : 'block';
            ...
            if (!collapsed) {
              ...
              if (value != 'simple' || iw >= 660) {
                var textElt = this.sidebar.createVertexTemplate(
                    'text;strokeColor=none;fillColor=none;html=1;' +
                    'align=center;verticalAlign=middle;whiteSpace=wrap;rounded=0;',
                    60, 30, 'Text',
                    mxResources.get('text') + ' (A)', true, false, null,
                    value != 'simple', null,
                    tw + 10, th + 10,
                    value == 'simple' ? Editor.thinTextImage : null, true);
                ...
                addElt(textElt, mxResources.get('text') + ' (A)', null, 'A',
                    32).style.margin = (value == 'simple') ?
                    '0 -8px 0 0' : '0 0 0 -2px';
              }

              var boxElt = this.sidebar.createVertexTemplate(
                  'rounded=0;whiteSpace=wrap;html=1;', 160, 80, '',
                  mxResources.get('rectangle') + ' (D)', true, false, null,
                  value != 'simple', null, tw, th,
              ...
              if (value == 'simple') {
                if (iw >= 600) {
                  ...
                  addElt(boxElt, mxResources.get('rectangle') + ' (D)', null,
                      'D').style.margin = '0 -4px 0 0';
                }
                ...
                if (iw >= 440) {
                  addElt(freehandElt, mxResources.get('freehand') + ' (X)',
                      null, 'X');
                }
                ...
                addElt(this.sidebar.createVertexTemplate(
                        ...
                        140, 160, '', mxResources.get('note') + ' (S)', true, false,
                        null, true, null, tw, th),
                    mxResources.get('note') + ' (S)', null,
                    'S').style.margin = margin;
                addElt(boxElt, mxResources.get('rectangle') + ' (D)', null,
                    'D').style.margin = margin;
                addElt(this.sidebar.createVertexTemplate(
                        'ellipse;whiteSpace=wrap;html=1;', 160, 100, '',
                        mxResources.get('ellipse') + ' (F)', true, false, null,
                        true, null, tw, th),
                    mxResources.get('ellipse') + ' (F)', null,
                    'F').style.margin = margin;

                var edgeStyle = 'edgeStyle=none;orthogonalLoop=1;jettySize=auto;html=1;';
                var cell = new mxCell('', new mxGeometry(0, 0,
                    this.editor.graph.defaultEdgeLength + 20, 0), edgeStyle);
                cell.geometry.setTerminalPoint(new mxPoint(0, 0), true);
                cell.geometry.setTerminalPoint(
                    new mxPoint(cell.geometry.width, 0), false);
                ...
                addElt(freehandElt, mxResources.get('freehand') + ' (X)', null,
                    'X');
                this.sketchPickerMenuElt.appendChild(shapesElt);
              }
        ...
        mxEvent.addListener(foldImg, 'click', mxUtils.bind(this, function () {
          if (collapsed) {
            mxUtils.setPrefixedStyle(picker.style, 'transform',
                'translate(0, -50%)');
      ...
      if (this.sketchMenubarElt == null) {
        ...
        if (value == 'simple') {
          ...
          if (this.commentElt == null) {
            this.commentElt = this.createMenuItem('comments',
                Editor.thinCommentImage, true);
          ...
          if (this.formatElt == null) {
            this.formatElt = this.createMenuItem('format',
                Editor.thinDesignImage, true);
            this.formatElt.style.backgroundSize = '24px';
            this.formatElt.style.marginLeft = (urlParams['embed'] != '1')
                ? 'auto' : '0';
            ...
            this.formatElt.className = cls + ((this.formatWidth == 0) ? ''
                : ' geActiveItem');
          ...
          this.sketchMenubarElt.style.cssText = 'position:absolute;right:12px;top:10px;height:44px;'
              ...
              +
              'box-sizing:border-box;justify-content:flex-end;z-index:1;padding:7px 12px;'
              + css;
        ...
        if (urlParams['embedInline'] != '1') {
          ...
          var refreshMenu = mxUtils.bind(this, function () {
            if (Editor.currentTheme == 'sketch') {
              ...
              if (this.commentElt != null) {
                this.commentElt.style.display = (iw > 560
                    && this.commentsSupported()) ? '' : 'none';
              }
  ...
  EditorUi.prototype.createMenu = function (key, img, className, clickFn) {
    ...
    var elt = this.menubar.addMenu(mxResources.get(key), menu.funct, null,
        clickFn);
  ...
  EditorUi.prototype.createFormatWindow = function () {
    if (this.formatWindow == null) {
      ...
      this.formatWindow = new WrapperWindow(this, mxResources.get('format'), x,
          y, 240, h,
          mxUtils.bind(this, function (container) {
            container.appendChild(this.formatContainer);
          }));

      this.formatWindow.window.addListener(mxEvent.SHOW,
          mxUtils.bind(this, function () {
      ...
      this.formatWindow.window.toggleMinimized = function () {
        ...
        if (this.minimized) {
          ...
          this.div.style.left = (parseInt(this.div.style.left) + w - 140)
              + 'px';
        } else {
          this.div.style.width = w + 'px';
          this.table.style.width = this.div.style.width;
          this.div.style.left = (Math.max(0,
              parseInt(this.div.style.left) - w + 140)) + 'px';
        }

        this.fit();
      };

      mxEvent.addListener(this.formatWindow.window.title, 'dblclick',
          mxUtils.bind(this, function (evt) {
  ...
  EditorUi.prototype.toggleShapesPanel = function (visible) {
    if (this.isShapesPanelVisible() != visible) {
      ...
      mxUtils.setPrefixedStyle(this.sidebarContainer.style, 'transform',
      ...
      window.setTimeout(mxUtils.bind(this, function () {
        ...
        mxUtils.setPrefixedStyle(this.sidebarContainer.style, 'transition',
            'transform ' + delay + 's ease-in-out');
        mxUtils.setPrefixedStyle(this.sidebarContainer.style,
  ...
  EditorUi.prototype.refresh = function (sizeDidChange) {
    if (this.sketchWrapperElt != null && this.sketchWrapperElt.parentNode
        != null) {
    ...
    if (this.sidebarWindow == null) {
      ...
      this.sidebarWindow = new WrapperWindow(this, mxResources.get('shapes'),
          ...
          (simpleTheme && urlParams['embedInline'] != '1') ?
              Math.max(30,
                  (this.diagramContainer.parentNode.clientHeight - h) / 2) : 56,
          w - 6, h - 6, mxUtils.bind(this, function (container) {
            this.createShapesPanel(container);
          }));

      this.sidebarWindow.window.addListener(mxEvent.SHOW,
          mxUtils.bind(this, function () {
  ...
  Editor.createMinimalCss = function () {
    ...
    return (Editor.isDarkMode() ?
                ...
                + Editor.darkColor + '; color: #cccccc; border-color: #505759; }' +
        ...
        + (Editor.isDarkMode() ? '#cccccc' : '#ffffff') + ' !important; }' +
  ...
  EditorUi.prototype.setAndPersistDarkMode = function (value) {
    ...
    if (value == 'auto') {
      actual = window.matchMedia && window.matchMedia(
  ...
  EditorUi.setGraphDarkMode = function (graph, container, darkMode) {
    ...
    graph.defaultPageBackgroundColor = (urlParams['embedInline'] == '1')
        ? 'transparent' :
    ...
    if (container != null) {
      container.style.backgroundColor = (urlParams['embedInline'] == '1')
          ? 'transparent' :
          (darkMode ? Editor.darkColor : '#ffffff');
    }
      ...
      var delayed = mxUtils.bind(this, function () {
        if (Editor.darkMode != value) {
          ...
          if (window.Format != null) {
            Format.inactiveTabBackgroundColor = Editor.isDarkMode() ? '#000000'
                : '#e4e4e4';
          }

          mxConstants.DROP_TARGET_COLOR = Editor.isDarkMode() ? '#00ff00'
              : '#0000FF';
  ...
  EditorUi.prototype.inlineSizeChanged = function () {
    ...
    if (Editor.inlineFullscreen) {
      ...
      if (this.diagramContainer.getAttribute('data-bounds') == null) {
        this.diagramContainer.setAttribute('data-bounds',
  ...
  EditorUi.prototype.updateDefaultStyles = function () {
    ...
    if (this.menus.defaultFontSize == Menus.prototype.defaultFontSize) {
      ...
      setStyle(graph.defaultVertexStyle, 'fontSize',
          this.menus.defaultFontSize);
      setStyle(graph.defaultEdgeStyle, 'fontSize',
          parseInt(this.menus.defaultFontSize) - 4);
    }
    ...
    if (Editor.sketchMode) {
      ...
      setStyle(graph.defaultVertexStyle, 'curveFitting',
      ...
      setStyle(graph.defaultEdgeStyle, 'curveFitting',
          Editor.sketchDefaultCurveFitting);
  ...
  EditorUi.prototype.installSettings = function () {
    if (Editor.isSettingsEnabled()) {
      ...
      this.addListener('copyConnectChanged',
          mxUtils.bind(this, function (sender, evt) {
       ...
       */
      this.editor.graph.pageFormat = (this.editor.graph.defaultPageFormat
          != null) ?
      ...
      this.editor.graph.view.gridColor = mxSettings.getGridColor(
          Editor.isDarkMode());
      this.editor.graph.view.defaultDarkGridColor = mxSettings.getGridColor(
          true);
      this.editor.graph.view.defaultGridColor = mxSettings.getGridColor(false);

      this.addListener('gridColorChanged',
          mxUtils.bind(this, function (sender, evt) {
      ...
      if (mxClient.IS_CHROMEAPP || EditorUi.isElectronApp) {
        this.editor.addListener('autosaveChanged',
            mxUtils.bind(this, function (sender, evt) {
      ...
      if (this.sidebar != null) {
        if (urlParams['search-shapes'] != null && this.sidebar.searchShapes
            != null) {
  ...
  EditorUi.prototype.copyImage = function (cells, xml, scale) {
    try {
      if (navigator.clipboard != null && typeof window.ClipboardItem
          === 'function' &&
        ...
        this.editor.exportToCanvas(
            mxUtils.bind(this, function (canvas, svgRoot) {
              try {
                ...
                var w = parseInt(svgRoot.getAttribute('width'));
                var h = parseInt(svgRoot.getAttribute('height'));
                this.writeImageToClipboard(dataUrl, w, h,
                    mxUtils.bind(this, function (e) {
                      this.handleError(e);
                    }));
              } catch (e) {
  ...
  EditorUi.prototype.writeImageToClipboard = function (dataUrl, w, h, error) {
    var blob = this.base64ToBlob(dataUrl.substring(dataUrl.indexOf(',') + 1),
        'image/png');
  ...
  EditorUi.prototype.pasteCells = function (evt, realElt, useEvent,
    ...
    if (!mxEvent.isConsumed(evt)) {
      ...
      if (useEvent && evt.clipboardData != null && evt.clipboardData.getData) {
        ...
        if (plain != null && plain.length > 0 && plain.substring(0, 18)
            == '%3CmxGraphModel%3E') {
          try {
      ...
      if (spans != null && spans.length > 0 && spans[0].getAttribute(
              'data-lucid-type') ===
      ...
      /*else if (spans != null && spans.length > 0 && spans[0].hasAttribute('data-meta')
        ...
        try {
          ...
          if (tmp && (this.isCompatibleString(tmp) ||
              tmp.substring(0, 20).replace(/\s/g, '').indexOf('{"isProtected":')
              == 0)) {
            compat = true;
            xml = tmp;
          }
        ...
        try {
          if (xml != null && xml.length > 0) {
            if (xml.substring(0, 20).replace(/\s/g, '').indexOf(
                '{"isProtected":') == 0) {
              var delayed = mxUtils.bind(this, function () {
                try {
  ...
  EditorUi.prototype.addFileDropHandler = function (elts) {
    ...
    if (Graph.fileSupport) {
      ...
      for (var i = 0; i < elts.length; i++) {
        ...
        mxEvent.addListener(elts[i], 'dragover',
            mxUtils.bind(this, function (evt) {
        ...
        mxEvent.addListener(elts[i], 'drop', mxUtils.bind(this, function (evt) {
          ...
          if (this.editor.graph.isEnabled() || urlParams['embed'] != '1') {
            if (evt.dataTransfer.files.length > 0) {
              ...
              if (data == null) {
                var provider = (evt.dataTransfer != null) ? evt.dataTransfer
                    : evt.clipboardData;

                if (provider != null) {
                  if (document.documentMode == 10 || document.documentMode
                      == 11) {
                    ...
                    } else if (mxUtils.indexOf(provider.types, 'text/plain')
                        >= 0) {
                  ...
                  if (data != null) {
                    ...
                    if (Editor.isPngDataUrl(data)) {
                      ...
                      if (this.isOffline()) {
                        ...
                        new mxXmlRequest(OPEN_URL,
                            'format=xml&data=' + encodeURIComponent(data)).send(
                            mxUtils.bind(this, function (req) {
                              if (req.getStatus() >= 200 && req.getStatus()
                                  <= 299) {
                                this.openLocalFile(req.getText(), null, true);
                              } else {
                                this.showError(mxResources.get('error'),
                                    req.getStatus() == 413 ? mxResources.get(
                                            'diagramTooLarge') :
                                        mxResources.get('unknownError'));
                              }
                            }));
                      ...
                      if (this.getCurrentFile() == null) {
                        ...
                        window.openWindow(((mxClient.IS_CHROMEAPP) ?
                                (EditorUi.drawHost + '/') : 'https://'
                                + location.host + '/') +
                            window.location.search + '#U' + encodeURIComponent(
                                data));
                      }
                    }
                  }
   ...
   */
  EditorUi.prototype.openFileHandle = function (data, name, file, temp,
      fileHandle) {
    if (name != null && name.length > 0) {
      ...
      if (/(\.v(dx|sdx?))($|\?)/i.test(name) || /(\.vs(x|sx?))($|\?)/i.test(
          name)) {
        this.importVisio(file, mxUtils.bind(this, function (xml) {
          this.spinner.stop();
          handleResult(xml);
   ...
   */
  EditorUi.prototype.openLocalFile = function (data, name, temp, fileHandle,
      desc) {
    var currentFile = this.getCurrentFile();
    ...
    var fn = mxUtils.bind(this, function () {
      ...
      if (name == null && this.getCurrentFile() != null
          && this.isDiagramEmpty()) {
        var doc = mxUtils.parseXml(data);
    ...
    if (data != null && data.length > 0) {
      if (currentFile == null || (!currentFile.isModified() &&
          (mxClient.IS_CHROMEAPP || EditorUi.isElectronApp || fileHandle
              != null))) {
        fn();
      } else if ((mxClient.IS_CHROMEAPP || EditorUi.isElectronApp || fileHandle
              != null) &&
  ...
  EditorUi.prototype.initializeEmbedMode = function () {
    ...
    if (parent != window) {
      if (urlParams['spin'] != '1' || this.spinner.spin(document.body,
                ...
                try {
                  ...
                  for (var id in cells) {
                    ...
                    if (cell != null && cell.style != null) {
                      cell.style += ';sketch=1;' + (cell.style.indexOf(
                          'fontFamily=') == -1 || cell.style.indexOf(
                          'fontFamily=Helvetica;') > -1 ?
  ...
  EditorUi.prototype.showLayersDialog = function () {
    if (this.editor.graph.getModel().getChildCount(
        this.editor.graph.getModel().getRoot()) > 1) {
      if (this.actions.layersWindow == null) {
  ...
  EditorUi.prototype.installMessageHandler = function (fn) {
    ...
    mxEvent.addListener(window, 'message', mxUtils.bind(this, function (evt) {
      ...
      if (urlParams['proto'] == 'json') {
        ...
        try {
          if (data == null) {
            ...
            this.showError(
                (data.titleKey != null) ? mxResources.get(data.titleKey)
                    : data.title,
                (data.messageKey != null) ? mxResources.get(data.messageKey)
                    : data.message,
                (data.buttonKey != null) ? mxResources.get(data.buttonKey)
                    : data.button);
            ...
            var dlg = new FilenameDialog(this, data.defaultValue || '',
                ...
                function (value) {
                  if (value != null) {
                    parent.postMessage(JSON.stringify(
                        {event: 'prompt', value: value, message: data}), '*');
                  } else {
                    parent.postMessage(
            ...
            if (urlParams['newTempDlg'] == '1' && !data.templatesOnly
                && data.callback != null) {
              var user = this.getCurrentUser();

              var tempDlg = new TemplatesDialog(this,
                  ...
                  enableRecentDocs ? mxUtils.bind(this,
                      function (recentReadyCallback, error, username) {
                        this.remoteInvoke('getRecentDiagrams', [username], null,
                            recentReadyCallback, error);
                      }) : null, enableSearchDocs ? mxUtils.bind(this,
                      function (searchStr, searchReadyCallback, error,
                          username) {
                        this.remoteInvoke('searchDiagrams',
                            [searchStr, username], null, searchReadyCallback,
                            error);
                      }) : null,
                  mxUtils.bind(this, function (obj, callback, error) {
                    this.remoteInvoke('getFileContent', [obj.url], null,
                        callback, error);
                  }), null, enableCustomTemp ? mxUtils.bind(this,
                      function (customTempCallback) {
                        this.remoteInvoke('getCustomTemplates', null, null,
                            customTempCallback, function () {
                              customTempCallback({}, 0); //ignore error by sending empty templates
                            });
                      }) : null, false, false, true, true);

              this.showDialog(tempDlg.container, window.innerWidth,
                  window.innerHeight, true, false, null, false, true);

              return;
            }

            var dlg = new NewDialog(this, false,
                ...
                enableRecentDocs ? mxUtils.bind(this,
                    function (recentReadyCallback) {
                      this.remoteInvoke('getRecentDiagrams', [null], null,
                          recentReadyCallback, function () {
                            recentReadyCallback(null, 'Network Error!');
                          });
                    }) : null,
                enableSearchDocs ? mxUtils.bind(this,
                    function (searchStr, searchReadyCallback) {
                      this.remoteInvoke('searchDiagrams', [searchStr, null],
                          null, searchReadyCallback, function () {
                ...
                enableCustomTemp ? mxUtils.bind(this,
                    function (customTempCallback) {
                      this.remoteInvoke('getCustomTemplates', null, null,
                          customTempCallback, function () {
                            customTempCallback({}, 0); //ignore error by sending empty templates
            ...
            var msg = (data.messageKey != null) ? mxResources.get(
            ...
            if (data.format == 'png' || data.format == 'xmlpng') {
              if ((data.spin == null && data.spinKey == null)
                  || this.spinner.spin(document.body,
                      (data.spinKey != null) ? mxResources.get(data.spinKey)
                          : data.spin)) {
                var xml = (data.xml != null) ? data.xml : this.getFileData(
                    true);
                ...
                var postDataBack = mxUtils.bind(this, function (uri, svg) {
                  if (data.withSvg) {
                    data.withSvg = false;
                    this.getEmbeddedSvg(xml, this.editor.graph, null, true,
                        function (svg) {
                          postDataBack(uri, svg);
                        }, null, null, data.embedImages,
                ...
                var pageId = data.pageId || (this.pages != null
                    ? ((data.currentPage) ?
                        this.currentPage.getId() : this.pages[0].getId())
                    : null);
                ...
                if (this.isExportToCanvas()) {
                  var graphReady = mxUtils.bind(this, function () {
                    ...
                    // LATER: Add caching for the graph or SVG while not on first page
                    if (this.pages != null && this.currentPage.getId()
                        != pageId) {
                      var graphGetGlobalVariable = graph.getGlobalVariable;
                    ...
                    if (data.layerIds != null) {
                      ...
                      for (var i = 0; i < layers.length; i++) {
                        graphModel.setVisible(layers[i],
                    ...
                    if (data.keepTheme) {
                      theme = (Editor.cssDarkMode || Editor.isDarkMode())
                          ? 'dark' : 'light'
                    }
                    ...
                    this.editor.exportToCanvas(
                        ...
                        }), data.width, null, data.background,
                        mxUtils.bind(this, function () {
                          processUri(null);
                        }), null, null, data.scale, data.transparent,
                        data.shadow,
                  ...
                  var req = new mxXmlRequest(EXPORT_URL,
                      'format=png&embedXml=' +
              ...
              var graphReady = mxUtils.bind(this, function () {
                ...
                if (data.format == 'html2' || (data.format == 'html'
                  ...
                  var bg = (data.background != null) ? data.background
                      : this.editor.graph.background;
                  ...
                  if (data.keepTheme) {
                    theme = (Editor.cssDarkMode || Editor.isDarkMode()) ? 'dark'
                        : 'light'
                  }
                  ...
                  if (data.format == 'xmlsvg') {
                    if ((data.spin == null && data.spinKey == null)
                        || this.spinner.spin(document.body,
                            (data.spinKey != null) ? mxResources.get(
                                data.spinKey) : data.spin)) {
                      this.getEmbeddedSvg(msg.xml, this.editor.graph, null,
                          true, postResult, null, null,
                          data.embedImages, bg, data.scale, data.border,
                          data.shadow, theme);
                    }
                  } else {
                    if ((data.spin == null && data.spinKey == null)
                        || this.spinner.spin(document.body,
                            (data.spinKey != null) ? mxResources.get(
                                data.spinKey) : data.spin)) {
                      this.editor.graph.setEnabled(false);
                      var svgRoot = this.editor.graph.getSvg(bg, data.scale,
                          data.border, null, null,
                          null, null, null, null,
            ...
            if (data.rect != null) {
              ...
              this.diagramContainer.style.left = Math.max(60, data.rect.left)
                  + 'px';
              this.diagramContainer.style.top = Math.max(40, data.rect.top)
                  + 'px';
            ...
            if (file != null) {
              ...
              if (tmp != null && tmp != '') {
                file.mergeFile(new LocalFile(this, tmp), function () {
                  ...
                  parent.postMessage(JSON.stringify(
                      {event: 'merge', message: data, error: err}), '*');
                });
              }
            }
            ...
            parent.postMessage(JSON.stringify(
                {error: 'unknownMessage', data: JSON.stringify(data)}), '*');
      ...
      var getData = mxUtils.bind(this, function () {
        return (urlParams['pages'] != '0' || (this.pages != null
            && this.pages.length > 1)) ?
      ...
      if (data != null && typeof data.substring === 'function'
          && data.substring(0, 34) == 'data:application/vnd.visio;base64,') {
        // Checks VND binary magic number in base64
        var filename = (data.substring(34, 45) == '0M8R4KGxGuE') ? 'raw.vsd'
            : 'raw.vsdx';
      ...
      } else if (data != null && typeof data.substring === 'function'
          && new XMLHttpRequest().upload && this.isRemoteFileFormat(data, '')) {
        if (this.isOffline()) {
          this.showError(mxResources.get('error'),
              mxResources.get('notInOffline'));
        } else {
          ...
          this.parseFileData(data, mxUtils.bind(this, function (xhr) {
            if (xhr.readyState == 4) {
              if (xhr.status >= 200 && xhr.status <= 299 &&
                ...
                this.handleError({
                  message: xhr.status == 413 ? mxResources.get(
                          'diagramTooLarge') :
                      mxResources.get('unknownError')
                });
              }
      ...
      } else if (data != null && typeof data === 'object' && data.format != null
    ...
    var parent = window.opener || window.parent;
    var msg = (urlParams['proto'] == 'json') ? JSON.stringify({event: 'init'})
   ...
   * Adds the buttons for embedded mode.
   */
  EditorUi.prototype.createEmbedButton = function (title, fn, shortcut,
      primary) {
  ...
  EditorUi.prototype.addEmbedButtons = function () {
    ...
    if (urlParams['noSaveBtn'] == '1') {
      if (urlParams['saveAndExit'] != '0') {
        div.appendChild(
            this.createEmbedButton(urlParams['publishClose'] == '1' ?
  ...
  EditorUi.prototype.showImportCsvDialog = function () {
    if (this.importCsvDialog == null) {
      this.importCsvDialog = new TextareaDialog(this,
          mxResources.get('csv') + ':',
          ...
          !this.isOffline()
              ? 'https://drawio-app.com/import-from-csv-to-drawio/' : null);
    }
    ...
    this.loadOrgChartLayouts(mxUtils.bind(this, function () {
      var dlg = new TextareaDialog(this, mxResources.get('layout'),
          ...
          mxUtils.bind(this, function (buttons, input) {
            var copyBtn = mxUtils.button(mxResources.get('copy'),
                mxUtils.bind(this, function () {
                  try {
  ...
  EditorUi.prototype.loadOrgChartLayouts = function (fn) {
    this.createTimeout(null, mxUtils.bind(this, function (timeout) {
      ...
      if (typeof mxOrgChartLayout === 'undefined' && !this.loadingOrgChart
          && !this.isOffline(true)) {
        if (this.spinner.spin(document.body, mxResources.get('loading'))) {
      ...
      if (lines.length > 0) {
        ...
        while (index < lines.length && lines[index].charAt(0) == '#') {
          ...
          lines[index].charAt(0) == '#') {
            text = text.substring(0, text.length - 1) + mxUtils.trim(
        ...
        for (var i = 0; i < keys.length; i++) {
          ...
          attribs.push(
              mxUtils.trim(keys[i]).replace(/[^a-z0-9]+/ig, '_').replace(/^\d+/,
                  '').replace(/_+$/, ''));
        }
        ...
        for (var i = index + 1; i < lines.length; i++) {
          ...
          if (values == null) {
            var short = (lines[i].length > 40) ? lines[i].substring(0, 40)
                + '...' : lines[i];
        ...
        try {
          for (var i = 0; i < arrays.length; i++) {
            var values = arrays[i];
            var cell = null;
            var id = (identityIndex != null) ? namespace + values[identityIndex]
                : null;
            ...
            if (cell.vertex) {
              ...
              var widthValue = (width.charAt(0) == '@') ? cell.getAttribute(
                  width.substring(1)) : null;
              ...
              var heightValue = (height.charAt(0) == '@') ? cell.getAttribute(
                  height.substring(1)) : null;

              if (heightValue != null && heightValue != 'auto') {
                cell.geometry.height = parseFloat(heightValue);
              } else {
                cell.geometry.height = (height == 'auto' || heightValue
                    == 'auto') ?
          ...
          for (var i = 0; i < parents.length; i++) {
            var widthValue = (width.charAt(0) == '@') ? parents[i].getAttribute(
                width.substring(1)) : null;
            var heightValue = (height.charAt(0) == '@')
                ? parents[i].getAttribute(height.substring(1)) : null;
          ...
          for (var e = 0; e < edges.length; e++) {
            ...
            for (var i = 0; i < allCells.length; i++) {
              ...
              var insertEdge = mxUtils.bind(this,
                    ...
                    if (tmp != null && tmp != '') {
                      ...
                      for (var j = 0; j < refs.length; j++) {
                        ...
                        if (ref == null && unknownStyle != null) {
                          ref = new mxCell(refs[j],
                              new mxGeometry(x0, y0, 0, 0), unknownStyle);
                          ref.style = graph.replacePlaceholders(dataCell,
                              ref.style, vars);
                          var refSize = this.editor.graph.getPreferredSizeForCell(
                              ref);
                        ...
                        if (ref != null) {
                          ...
                          if (edge.fromlabel != null) {
                            label = (dataCell.getAttribute(edge.fromlabel)
                                || '') + (label || '');
                          }
                          ...
                          var edgeStyle = (edge.style != null) ?
                              graph.replacePlaceholders(placeholders,
                                  edge.style, vars) :
                              graph.createCurrentEdgeStyle();

                          var edgeCell = graph.insertEdge(null, null,
                              label || '', (edge.invert) ?
                                  ref : realCell,
                              (edge.invert) ? realCell : ref, edgeStyle);
          ...
          if (cells.length > 0) {
            ...
            if (layout.charAt(0) == '[') {
              ...
              this.executeLayouts(graph.createLayouts(JSON.parse(layout)),
                  function () {
                    postProcess();
                    temp();
                  });
              ...
              afterInsert = null;
                ...
                (layout == 'auto' && select.length == 2 * cells.length - 1
                    && roots.length == 1)) {
              // Required for layouts to work with new cells
              graph.view.validate();
  ...
  EditorUi.prototype.getSearch = function (exclude) {
    ...
    if (urlParams['offline'] != '1' && urlParams['demo'] != '1' && exclude
        != null && window.location.search.length > 0) {
      var amp = '?';
  ...
  EditorUi.prototype.getUrl = function (pathname) {
    ...
    if (urlParams['offline'] == '1') {
      ...
      var ignored = ['tmp', 'libs', 'clibs', 'state', 'fileId', 'code', 'share',
        'notitle',
  ...
  EditorUi.prototype.showLinkDialog = function (value, btnLabel, fn,
      showNewWindowOption, linkTarget) {
  ...
  EditorUi.prototype.updateActionStates = function () {
    ...
    this.actions.get('autosave').setEnabled(
    ...
    this.actions.get('editConnectionPoints').setEnabled(
        active && ss.edges.length == 0 && ss.vertices.length == 1);
    this.actions.get('editImage').setEnabled(
        active && ss.image && ss.cells.length > 0);
    this.actions.get('crop').setEnabled(
        active && ss.image && ss.cells.length > 0);
    ...
    this.actions.get('copyStyle').setEnabled(
        active && !graph.isSelectionEmpty());
    this.actions.get('pasteStyle').setEnabled(
        this.copiedStyle != null && active && ss.cells.length > 0);
    ...
    this.actions.get('makeCopy').setEnabled(
        file != null && !file.isRestricted());
    this.actions.get('editDiagram').setEnabled(
        active && (file == null || !file.isRestricted()));
    this.actions.get('publishLink').setEnabled(
        file != null && !file.isRestricted());
    this.actions.get('tags').setEnabled(
        this.diagramContainer.style.visibility != 'hidden');
    this.actions.get('layers').setEnabled(
        this.diagramContainer.style.visibility != 'hidden');
    this.actions.get('outline').setEnabled(
        this.diagramContainer.style.visibility != 'hidden');
    this.actions.get('rename').setEnabled(
  ...
  if (window.ExportDialog != null) {
    ...
    ExportDialog.exportFile = function (editorUi, name, format, bg, s, b, dpi,
      ...
      if (format == 'xml') {
        editorUi.hideDialog();
        editorUi.saveData(name, 'xml',
            mxUtils.getXml(editorUi.editor.getGraphXml()), 'text/xml');
      } else if (format == 'svg') {
        editorUi.hideDialog();
        editorUi.saveData(name, 'svg', mxUtils.getXml(graph.getSvg(bg, s, b)),
            'image/svg+xml');
      } else {
          ...
          if ((format == 'png' || format == 'jpg' || format == 'jpeg')
            ...
            editorUi.saveRequest(name, format,
                function (newTitle, base64) {
                  return new mxXmlRequest(EXPORT_URL,
                      'format=' + format + '&base64=' + (base64 || '0') +
                      ((newTitle != null) ? '&filename=' + encodeURIComponent(
                          newTitle) : '') +
                      '&extras=' + encodeURIComponent(JSON.stringify(extras)) +
                      (dpi > 0 ? '&dpi=' + dpi : '') +
                      '&bg=' + ((bg != null) ? bg : 'none') + '&w=' + w + '&h='
                      + h +
  ...
  EditorUi.prototype.getDiagramTextContent = function () {
    ...
    if (this.pages != null) {
      for (var i = 0; i < this.pages.length; i++) {
        ...
        allPagesTxt += this.pages[i].getName() + ' '
            + pageGraph.getIndexableText() + ' ';
      }
    } else {
  ...
  EditorUi.prototype.showRemotelyStoredLibrary = function (title) {
    ...
    libsSection.innerHTML = '<div style="text-align:center;padding:8px;"><img src="'
        + IMAGE_PATH + '/spin.gif"></div>';
    ...
    this.remoteInvoke('getCustomLibraries', null, null, function (libsList) {
      ...
      if (libsList.length == 0) {
        ...
        for (var i = 0; i < libsList.length; i++) {
          ...
          var libCheck = this.addCheckbox(libsSection, lib.title,
              loadedLibs[lib.id]);
    ...
    var dlg = new CustomDialog(this, div, mxUtils.bind(this, function () {
          ...
          for (var id in selectedLibs) {
            ...
            (mxUtils.bind(this, function (lib) {
              this.remoteInvoke('getFileContent', [lib.downloadUrl], null,
    ...
    this.showDialog(dlg.container, 340, 390, true, true, null, null, null, null,
        true);
  };
  ...
  EditorUi.prototype.handleRemoteInvokeResponse = function (msg) {
    ...
    if (callback == null) {
      throw new Error(
          'No callback for ' + ((msgMarkers != null) ? msgMarkers.callbackId
              : 'null'));
    } else if (msg.error) {
      if (callback.error) {
        callback.error(msg.error.errResp);
      }
  ...
  EditorUi.prototype.remoteInvoke = function (remoteFn, remoteFnArgs,
      msgMarkers, callback, error) {
        ...
        try {
          ...
          req.onsuccess = mxUtils.bind(this, function (e) {
            try {
              ...
              if (location.host == 'app.diagrams.net'
                  && !this.drawioMigrationStarted) {
                this.drawioMigrationStarted = true;

                this.getDatabaseItem('.drawioMigrated3',
                    mxUtils.bind(this, function (value) {
                      ...
                      var fetchOneFile = mxUtils.bind(this, function () {
                        try {
                          ...
                          StorageFile.getFileContent(this, fileTitle,
                              mxUtils.bind(this, function (data) {
                                if (data == null || (fileTitle == '.scratchpad'
                                    && data == this.emptyLibraryXml)) //Don't overwrite
                                {
                        ...
                        try {
                          ...
                          if (drawMsg.event == 'init') {
                            ...
                            drawioFrame.contentWindow.postMessage(
                              ...
                              && !allDone) {
                            if (collectNames) {
                              if (drawMsg.resp != null && drawMsg.resp.length
                                  > 0 && drawMsg.resp[0] != null) {
      ...
      try {
        ...
        for (var i = 0; i < storeName.length; i++) {
          trx.objectStore(storeName[i]).put(
              key != null && key[i] != null ? {key: key[i], data: data[i]}
                  : data[i]);
        }
      } catch (e) {
        if (error != null) {
   ...
   */
  EditorUi.prototype.getDatabaseItem = function (key, success, error,
      storeName) {
    this.openDatabase(mxUtils.bind(this, function (db) {
      try {
        storeName = storeName || 'objects';
   ...
   */
  EditorUi.prototype.getDatabaseItemKeys = function (success, error,
      storeName) {
    this.openDatabase(mxUtils.bind(this, function (db) {
      try {
        storeName = storeName || 'objects';
  ...
  EditorUi.prototype.newComment = function (content, user) {
    ...
    if (file != null) {
      ...
      return new DrawioComment(this, null, content, Date.now(), Date.now(),
          false, user);
    }
  };
  ...
  //===========To Be Removed Soon==========
  EditorUi.prototype.loadUrl = function (url, success, error, forceBinary,
      retry, dataUriPrefix, noBinary, headers) {
    EditorUi.logEvent('SHOULD NOT BE CALLED: loadUrl');
    return this.editor.loadUrl(url, success, error, forceBinary, retry,
        dataUriPrefix, noBinary, headers);
  };
  ...
  EditorUi.prototype.exportToCanvas = function (callback, width, imageCache,
      background, error, limitHeight,
      ignoreSelection, scale, transparentBackground, addShadow, converter,
      graph, border, noCrop, grid, theme) {
    EditorUi.logEvent('SHOULD NOT BE CALLED: exportToCanvas');
    return this.editor.exportToCanvas(callback, width, imageCache, background,
        error, limitHeight,
        ignoreSelection, scale, transparentBackground, addShadow, converter,
        graph, border,
        noCrop, grid, theme);
  ...
  EditorUi.prototype.convertImages = function (svgRoot, callback, imageCache,
      converter) {
  ...
  EditorUi.prototype.writeGraphModelToPng = function (data, type, key, value,
      error) {
  ...
  EditorUi.prototype.getLocalStorageFileNames = function () {
    ...
    for (var i = 0; i < localStorage.length; i++) {
      ...
      if (key.length > 0 && (key == '.scratchpad' || key.charAt(0) != '.')
          && value.length > 0) {
        var isFile = (value.substring(0, 8) === '<mxfile ' ||
            value.substring(0, 5) === '<?xml' || value.substring(0, 12)
            === '<!--[if IE]>');
...
var CommentsWindow = function (editorUi, x, y, w, h, saveCallback) {
  ...
  function addComment(comment, parentArr, parent, level, showResolved) {
    ...
    function addReply(initContent, editIt, saveCallback, doResolve, doReopen) {
      ...
      var newReply = editorUi.newComment(initContent,
        ...
        editorUi.confirm(mxResources.get('areYouSure'), function () {
          ...
          comment.deleteComment(function (markedOnly) {
            if (markedOnly === true) {
              ...
              noComments.style.display = (listDiv.getElementsByTagName(
                  'div').length == 0) ? 'block' : 'none';
            }
          }, function (err) {
            showError(cdiv);
            editorUi.handleError(err, null, null, null,
      ...
      function toggleResolve(evt) {
        function doToggle() {
          ...
          mxUtils.write(resolveActionLnk,
              comment.isResolved ? mxResources.get('reopen') : mxResources.get(
                  'resolve'));
          var actionsDisplay = comment.isResolved ? 'none' : '';
          var replies = collectReplies(comment).replies;
          var color = (Editor.isDarkMode()) ? 'transparent'
              : (comment.isResolved ? 'ghostWhite' : 'white');

          for (var i = 0; i < replies.length; i++) {
            replies[i].style.backgroundColor = color;

            var forOpenActions = replies[i].querySelectorAll(
                '.geCommentAction');

            for (var j = 0; j < forOpenActions.length; j++) {
              if (forOpenActions[j] == resolveActionLnk.parentNode) {
                continue;
              }
        ...
        if (comment.isResolved) {
          addReply(mxResources.get('reOpened') + ': ', true, doToggle, false,
              true);
        } else {
    ...
    for (var i = 0; comment.replies != null && i < comment.replies.length;
        i++) {
    ...
    if (curEdited != null) {
      if (curEdited.comment.id == comment.id) {
        ...
        editComment(comment, cdiv, curEdited.saveCallback,
            curEdited.deleteOnCancel);
        comment.content = origContent;
      } else if (curEdited.comment.id == null && curEdited.comment.pCommentId
          == comment.id) {
        listDiv.appendChild(curEdited.div);
        editComment(curEdited.comment, curEdited.div, curEdited.saveCallback,
            curEdited.deleteOnCancel);
      }
    }
  ...
  resolvedLink.innerHTML = '<img class="geAdaptiveAsset" src="' + IMAGE_PATH
  ...
  if (editorUi.commentsRefreshNeeded()) {
    ...
    refreshLink.innerHTML = '<img class="geAdaptiveAsset" src="' + IMAGE_PATH
  ...
  if (editorUi.commentsSaveNeeded()) {
    ...
    saveLink.innerHTML = '<img src="' + IMAGE_PATH
  ...
  var refresh = mxUtils.bind(this, function () {
    ...
    listDiv.innerHTML = '<div style="padding-top:10px;text-align:center;"><img src="'
        + IMAGE_PATH + '/spin.gif" valign="middle"> ' +
    ...
    if (editorUi.commentsSupported()) {
      editorUi.getComments(function (list) {
        ...
        //New comment case
        if (curEdited != null && curEdited.comment.id == null
  ...
  this.window = new mxWindow(mxResources.get('comments'), div, x, y, w, h, true,
      true);
 ...
 *
 */
var ConfirmDialog = function (editorUi, message, okFn, cancelFn, okLabel,
    cancelLabel,
  ...
  var cancelBtn = mxUtils.button(cancelLabel || mxResources.get('cancel'),
      function () {
        editorUi.hideDialog();
