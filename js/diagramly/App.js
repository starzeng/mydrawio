  ...
  if (!mxClient.IS_CHROMEAPP && !EditorUi.isElectronApp) {
    window.onunload = mxUtils.bind(this, function () {
      ...
      if (file != null && file.isModified()) {
        ...
        if (file.constructor == DriveFile && file.desc != null && this.drive
            != null) {
          evt.label += ((this.drive.user != null) ? ('-user_'
                  + this.drive.user.id) : '-nouser') + '-rev_' +
  ...
  window.openWindow = mxUtils.bind(this, function (url, pre, fallback) {
    if (urlParams['openInSameWin'] == '1' || navigator.standalone) {
      ...
      if (wnd == null || wnd === undefined) {
        this.showDialog(new PopupDialog(this, url, pre, fallback).container,
            320, 140, true, true);
      } else if (pre != null) {
        pre();
      }
 ...
 */
App.ONEDRIVE_URL = mxClient.IS_IE11 ? 'https://js.live.net/v7.2/OneDrive.js'
 ...
 */
App.TRELLO_JQUERY_URL = window.DRAWIO_BASE_URL
 ...
 * SimplePeer library
 */
App.SIMPLE_PEER_URL = window.DRAWIO_BASE_URL
    + '/js/simplepeer/simplepeer9.10.0.min.js';
...
(function () {
  if (!mxClient.IS_CHROMEAPP) {
    if (urlParams['offline'] != '1') {
      ...
      if (window.location.hostname == 'db.draw.io' && urlParams['mode']
          == null) {
      ...
      if (urlParams['embed'] != '1') {
        ...
        if (typeof window.OneDriveClient === 'function') {
          if (urlParams['od'] != '0' && (navigator.userAgent == null ||
              navigator.userAgent.indexOf('MSIE') < 0 || document.documentMode
              >= 10)) {
            // Immediately loads client
...
App.main = function (callback, createUi) {
  try {
    ...
    if (window.mxscript != null) {
      ...
      if (urlParams['dev'] == '1' && !mxClient.IS_CHROMEAPP
          && !EditorUi.isElectronApp &&
          CryptoJS != null && App.mode != App.MODE_DROPBOX && App.mode
          != App.MODE_TRELLO) {
        ...
        if (scripts != null && scripts.length > 0) {
          ...
          if (CryptoJS.MD5(content).toString()
              != '97d48990b1ef6de28697d2cc7083ca53') {
            console.log('Change bootstrap script MD5 in the previous line:',
        ...
        if (scripts != null && scripts.length > 1) {
          ...
          if (CryptoJS.MD5(content).toString()
            ...
            console.log('Change main script MD5 in the previous line:',
                CryptoJS.MD5(content).toString());
      ...
      // Loads Pusher API
      if (('ArrayBuffer' in window) && !mxClient.IS_CHROMEAPP
          && !EditorUi.isElectronApp &&
      ...
      if (urlParams['plugins'] != '0' && urlParams['offline'] != '1') {
        ...
        var plugins = (mxSettings.settings != null) ? mxSettings.getPlugins()
            : null;
        ...
        if (mxSettings.settings == null && isLocalStorage && typeof (JSON)
            !== 'undefined') {
          try {
        ...
        if (plugins != null && plugins.length > 0 && urlParams['plugins']
            != '0') {
          for (var i = 0; i < plugins.length; i++) {
            try {
              ...
              } else if (!ALLOW_CUSTOM_PLUGINS && !App.isBuiltInPlugin(
                  plugins[i])) {
                if (window.console != null) {
      ...
      if (typeof window.DriveClient === 'function' &&
          (typeof gapi === 'undefined' && (((urlParams['embed'] != '1'
                      && urlParams['gapi'] != '0') ||
        ...
        mxscript(
            ...
            null, null, null, mxClient.IS_SVG);
      }
      // Disables client
    ...
    function doLoad(bundle) {
      ...
      mxUtils.getAll((urlParams['dev'] != '1') ? [bundle] : [bundle,
        ...
        // Configuration mode
        if (isLocalStorage && localStorage != null && window.location.hash
            != null &&
          ...
          try {
            ...
            if (value != null) {
              ...
              if (confirm(mxResources.get('configLinkWarn')) &&
                ...
                localStorage.setItem(Editor.configurationKey,
        ...
        function realMain() {
          try {
            ...
            if (window.mxscript != null) {
              ...
              // KNOWN: Picker does not work in IE11 (https://dropbox.zendesk.com/requests/1650781)
              if (typeof window.DropboxClient === 'function' &&
                  (window.Dropbox == null && window.DrawDropboxClientCallback
                      != null &&
                      (((urlParams['embed'] != '1' && urlParams['db'] != '0') ||
                              (urlParams['embed'] == '1' && urlParams['db'] == '1'))
                          &&
                          isSvgBrowser && (document.documentMode == null
              ...
              if (typeof window.OneDriveClient === 'function' &&
                  (typeof OneDrive === 'undefined'
                      ...
                      (((urlParams['embed'] != '1' && urlParams['od'] != '0')
                          || (urlParams['embed'] == '1' &&
                              urlParams['od'] == '1')) && (navigator.userAgent
                          == null ||
            ...
            if (urlParams['chrome'] != '0' && urlParams['test'] == '1') {
              EditorUi.debug('App.start',
                  [ui, (new Date().getTime() - t0.getTime()) + 'ms']);
    ...
    if (urlParams['configure'] == '1') {
      ...
      if (Editor.config == null) {
        ...
        if (isLocalStorage && localStorage != null && urlParams['embed']
            != '1') {
...
App.prototype.initializeEmbedMode = function () {
  if (urlParams['embed'] == '1') {
    if (window.location.hostname == 'app.diagrams.net') {
      this.showBanner('EmbedDeprecationFooter',
...
App.prototype.init = function () {
  ...
  if (urlParams['embed'] != '1' || urlParams['od'] == '1') {
    ...
    var initOneDriveClient = mxUtils.bind(this, function () {
      if (typeof OneDrive !== 'undefined') {
        ...
        this.oneDrive.addListener('userChanged',
    ...
    var initTrelloClient = mxUtils.bind(this, function () {
      if (typeof window.Trello !== 'undefined') {
        try {
          ...
          this.trello.addListener('userChanged',
              mxUtils.bind(this, function () {
                this.updateUserElement();
                this.restoreLibraries();
              }));
  ...
  if (urlParams['embed'] != '1' || urlParams['db'] == '1') {
    ...
    var initDropboxClient = mxUtils.bind(this, function () {
      if (typeof Dropbox === 'function' && typeof Dropbox.choose
          !== 'undefined') {
        /**
        ...
        try {
          ...
          this.dropbox.addListener('userChanged',
              mxUtils.bind(this, function () {
                this.updateUserElement();
                this.restoreLibraries();
              }));
  ...
  if (urlParams['embed'] != '1') {
      ...
      window.addEventListener('beforeinstallprompt',
          mxUtils.bind(this, function (e) {
            this.showBanner('AddToHomeScreenFooter',
                mxResources.get('installApp'), function () {
                  e.prompt();
                });
          }));
    }

    if (this.isOwnDomain() && (!this.editor.chromeless
      ...
      this.editor.addListener('fileLoaded', mxUtils.bind(this, function () {
        ...
        if (!mxClient.IS_CHROMEAPP && !mxClient.IS_ANDROID && !mxClient.IS_IOS
            &&
            !EditorUi.isElectronApp && !this.isOffline() && urlParams['open']
            == null &&
            urlParams['extAuth'] != '1' && (mode == App.MODE_DEVICE || mode
                == App.MODE_BROWSER)) {
    ...
    if (!mxClient.IS_CHROMEAPP && !EditorUi.isElectronApp && DrawioFile.SYNC
        == 'auto' &&
        urlParams['local'] != '1' && urlParams['stealth'] != '1'
        && !this.isOffline() &&
        Editor.enableRealtimeCache && (!this.editor.chromeless
            || this.editor.editable)) {
      ...
      mxUtils.get(EditorUi.cacheUrl + '?alive',
          mxUtils.bind(this, function (req) {
            Editor.enableRealtimeCache = req.getStatus() >= 200
                && req.getStatus() <= 299;
  ...
  if (this.menubar != null) {
    ...
    if (Editor.currentTheme == 'atlas' || urlParams['atlas'] == '1') {
      ...
      if (urlParams['embed'] != '1') {
        ...
        mxEvent.addListener(this.icon, 'click',
            mxUtils.bind(this, function (evt) {
              this.appIconClicked(evt);
            }));
      }

      this.menubar.container.insertBefore(this.icon,
...
App.logAncestorFrames = function () {
  ...
  try {
    if (window.location.ancestorOrigins && window.location.hostname &&
      ...
      if (hostname && hostname.length > 1 && hostname.charAt(
          hostname.length - 1) == '/') {
      ...
      if (hostname.endsWith('embed.diagrams.net')
          && window.location.ancestorOrigins.length > 0) {
        var img = new Image();
        img.src = 'https://log.diagrams.net/images/1x1.png?src=EditorEmbedAncestorFrames'
            +
            '&v=' + encodeURIComponent(EditorUi.VERSION) + '&data='
...
App.prototype.sanityCheck = function () {
  ...
  if (file != null && file.isModified() && file.isAutosave()
    ...
    if (file.constructor == DriveFile && file.desc != null && this.drive
        != null) {
      evt.label += ((this.drive.user != null) ? ('-user_' + this.drive.user.id)
              : '-nouser') + '-rev_' +
          file.desc.headRevisionId + '-mod_' + file.desc.modifiedDate + '-size_'
          + file.getSize() +
          '-mime_' + file.desc.mimeType;
    }
    ...
    this.showError(mxResources.get('unsavedChanges'), msg,
...
App.prototype.showNameChangeBanner = function () {
  this.showBanner('DiagramsFooter', 'draw.io is now diagrams.net',
      mxUtils.bind(this, function () {
...
App.prototype.showNameConfBanner = function () {
  this.showBanner('ConfFooter', 'Try draw.io for Confluence',
      mxUtils.bind(this, function () {
        this.openLink(
...
App.prototype.showDownloadDesktopBanner = function () {
  this.showBanner('DesktopFooter', mxResources.get('downloadDesktop'),
      mxUtils.bind(this, function () {
...
App.prototype.showRatingBanner = function () {
  if (!this.bannerShowing && !this['hideBanner' + 'ratingFooter'] &&
    ...
    var hide = mxUtils.bind(this, function () {
      mxUtils.setPrefixedStyle(banner.style, 'transform',
          'translate(-50%,120%)');
...
App.prototype.checkLicense = function () {
  ...
  if (!this.isOffline() && !this.editor.chromeless && email != null
    ...
    mxUtils.post('/license',
        'domain=' + encodeURIComponent(domain) + '&id=' + encodeURIComponent(
            userId) +
        '&ts=' + new Date().getTime(),
        mxUtils.bind(this, function (req) {
          try {
...
App.prototype.getEditBlankXml = function () {
  ...
  if (file != null && this.editor.isChromelessView()
...
App.prototype.updateActionStates = function () {
  ...
  this.actions.get('revisionHistory').setEnabled(
      this.isRevisionHistoryEnabled());
};
...
App.prototype.onBeforeUnload = function () {
  if (urlParams['embed'] == '1' && this.editor.modified) {
    ...
    if (file != null) {
      ...
      if (file.constructor == LocalFile && file.getHash() == ''
          && !file.isModified() &&
          urlParams['nowarn'] != '1' && !this.isDiagramEmpty()
          && urlParams['url'] == null &&
...
App.prototype.getThumbnail = function (width, fn) {
  ...
  try {
    ...
    if (this.pages != null && (darkTheme || this.currentPage
        != this.pages[0])) {
    ...
    if (mxClient.IS_CHROMEAPP || this.useCanvasForExport) {
      this.editor.exportToCanvas(mxUtils.bind(this, function (canvas) {
            try {
              ...
              if (graph != this.editor.graph && graph.container.parentNode
                  != null) {
      ...
      ctx.save();
      ctx.fillStyle = bg;
      ctx.fillRect(x0, y0, Math.ceil(bounds.width + 4),
    ...
    // Removes temporary graph from DOM
    if (graph != null && graph != this.editor.graph
  ...
  App.prototype.setMode = function (mode, remember) {
    ...
    if (this.appIcon != null) {
      ...
      if (mode == App.MODE_GOOGLE) {
        this.appIcon.setAttribute('title',
        ...
        this.appIcon.style.cursor = (mode == App.MODE_DEVICE) ? 'pointer'
            : 'default';
      }
    }
...
App.prototype.open = function () {
  ...
  try {
    ...
    if (window.opener != null) {
      ...
      if (value != null && value.length > 0 && value.substring(0, 7)
          != 'http://' &&
        ...
        window.opener.openFile.setConsumer(
            mxUtils.bind(this, function (xml, filename, temp) {
              ...
              var dot = (!this.useCanvasForExport) ? filename.substring(
                  filename.length - 4) == '.png' : -1;
...
App.prototype.loadGapi = function (then) {
  if (typeof gapi !== 'undefined') {
    gapi.load(((urlParams['picker'] != '0') ? 'picker,' : '') + App.GOOGLE_APIS,
        then);
  }
};
    ...
    if (urlParams['embed'] != '1') {
      if (this.spinner.spin(document.body, mxResources.get('starting'))) {
        ...
        if ((window.location.hash == null || window.location.hash.length == 0)
            &&
            this.drive != null && this.stateArg != null && this.stateArg.userId
            != null) {
  ...
  try {
    ...
    if (urlParams['client'] != '1' && urlParams['embed'] != '1') {
      ...
      try {
        ...
        if (!mxClient.IS_CHROMEAPP && !EditorUi.isElectronApp
            && !this.isOfflineApp() &&
            urlParams['open'] == null && /www\.draw\.io$/.test(
      ...
      mxEvent.addListener(window, 'hashchange',
          mxUtils.bind(this, function (evt) {
            try {
    ...
    // Redirects old url URL parameter to new #U format
      ...
      var done = mxUtils.bind(this, function () {
        ...
        if (urlParams['client'] == '1' && (window.location.hash == null ||
            window.location.hash.length == 0 || window.location.hash.substring(
                0, 2) == '#P')) {
          var doLoadFile = mxUtils.bind(this, function (xml) {
            ...
            if (window.location.hash != null && window.location.hash.substring(
                0, 2) == '#P') {
          ...
          if (urlParams['demo'] == '1') {
            ...
            if (waiting) {
              ...
              if (EditorUi.enableDrafts && urlParams['mode'] == null &&
                  this.getServiceName() == 'draw.io' && (id == null || id.length
                      == 0) &&
              ...
              } else if (urlParams['splash'] != '0' || urlParams['mode']
                  != null) {
                this.loadFile();
      ...
      if ((window.location.hash == null || window.location.hash.length <= 1) &&
          value != null && value.length > 0 && this.spinner.spin(document.body,
        ...
        var showCreateDialog = mxUtils.bind(this, function (xml) {
          ...
          if (urlParams['splash'] != '0') {
            ...
            var dlg = new CreateDialog(this, title,
            ...
            this.showDialog(dlg.container, 420,
        ...
        if (value.substring(0, 7) != 'http://' && value.substring(0, 8)
            != 'https://') {
          // Cross-domain window access is not allowed in FF, so if we
          // were opened from another domain then this will fail.
          try {
        ...
        if ((window.location.hash == null || window.location.hash.length <= 1)
            &&
            urlParams['state'] != null && this.stateArg != null
        ...
        } else if ((window.location.hash == null || window.location.hash.length
                <= 1) &&
            this.drive != null && this.stateArg != null && this.stateArg.action
            == 'create') {
          if (window.history && window.history.replaceState) {
            // Removes state URL parameter without reloading the page
            window.history.replaceState(null, null, window.location.pathname +
          ...
          if (urlParams['open'] != null && window.history
...
App.prototype.loadDraft = function (xml, success) {
  this.createFile(this.defaultFilename, xml, null, null,
      mxUtils.bind(this, function () {
        window.setTimeout(mxUtils.bind(this, function () {
          var file = this.getCurrentFile();
          ...
          if (key != null && key.substring(0, 7) == '.draft_') {
            ...
            if (obj != null && obj.type == 'draft' && obj.aliveCheck != guid &&
                ((filePath == null && obj.fileObject == null) ||
                    (obj.fileObject != null && obj.fileObject.path
                        == filePath))) {
              obj.key = key;
              drafts.push(obj);
            }
    ...
    window.setTimeout(mxUtils.bind(this, function () {
      ...
      this.filterDrafts(null, guid, mxUtils.bind(this, function (drafts) {
        if (drafts.length == 1) {
          ...
          var dlg = new DraftDialog(this,
              (drafts.length > 1) ? mxResources.get('selectDraft') :
                  mxResources.get('draftFound', [ts.toLocaleDateString() + ' '
              ...
              mxUtils.bind(this, function (index) {
                ...
                this.loadDraft(drafts[index].data,
                    mxUtils.bind(this, function () {
                ...
                // Discard draft
                this.confirm(mxResources.get('areYouSure'), null,
                    mxUtils.bind(this, function () {
                      this.removeDatabaseItem(drafts[index].key);
      ...
      reader.onload = mxUtils.bind(this, function (e) {
        try {
          if (success != null) {
            ...
            this.openFileHandle(e.target.result, file.name, file, false,
                fileHandle);
          }
        } catch (e) {
          error(e);
...
App.prototype.pickFile = function (mode) {
  try {
    ...
    if (mode == App.MODE_GOOGLE) {
      if (this.drive != null && typeof (google) != 'undefined'
        ...
        window.openFile.setConsumer(
            mxUtils.bind(this, function (xml, filename) {
              ...
              if (currentFile == null || !currentFile.isModified()) {
                ...
                this.confirm(mxResources.get('allChangesLost'), null,
                    doOpenFile,
...
App.prototype.pickLibrary = function (mode) {
  ...
  if (mode == App.MODE_GOOGLE || mode == App.MODE_DROPBOX || mode
      == App.MODE_ONEDRIVE ||
      mode == App.MODE_GITHUB || mode == App.MODE_GITLAB || mode
      == App.MODE_TRELLO) {
    ...
    window.openFile.setConsumer(mxUtils.bind(this, function (xml, filename) {
      try {
        this.loadLibrary(
            (mode == App.MODE_BROWSER) ? new StorageLibrary(this, xml, filename)
                :
 ...
 * @param {number} dy Y-coordinate of the translation.
 */
App.prototype.saveLibrary = function (name, images, file, mode, noSpin,
    noReload, fn) {
  try {
    mode = (mode != null) ? mode : this.mode;
    ...
    if (file == null) {
      this.pickFolder(mode, mxUtils.bind(this, function (folderId) {
        if (mode == App.MODE_GOOGLE && this.drive != null && this.spinner.spin(
            document.body, mxResources.get('inserting'))) {
          this.drive.insertFile(name, xml, folderId,
          ...
          this.gitHub.insertLibrary(name, xml,
              mxUtils.bind(this, function (newFile) {
                this.spinner.stop();
                this.hideDialog(true);
                this.libraryLoaded(newFile, images);
            ...
            && this.spinner.spin(document.body, mxResources.get('inserting'))) {
          this.gitLab.insertLibrary(name, xml,
              mxUtils.bind(this, function (newFile) {
                this.spinner.stop();
                this.hideDialog(true);
                this.libraryLoaded(newFile, images);
            ...
            && this.spinner.spin(document.body, mxResources.get('inserting'))) {
          this.trello.insertLibrary(name, xml,
              mxUtils.bind(this, function (newFile) {
                this.spinner.stop();
                this.hideDialog(true);
                this.libraryLoaded(newFile, images);
            ...
            && this.spinner.spin(document.body, mxResources.get('inserting'))) {
          this.dropbox.insertLibrary(name, xml,
              mxUtils.bind(this, function (newFile) {
                this.spinner.stop();
                this.hideDialog(true);
                this.libraryLoaded(newFile, images);
            ...
            && this.spinner.spin(document.body, mxResources.get('inserting'))) {
          this.oneDrive.insertLibrary(name, xml,
              mxUtils.bind(this, function (newFile) {
                this.spinner.stop();
                this.hideDialog(true);
                this.libraryLoaded(newFile, images);
    ...
    } else if (noSpin || this.spinner.spin(document.body,
...
App.prototype.saveFile = function (forceDialog, success) {
  ...
  if (file != null) {
    ...
    if (!forceDialog && file.getTitle() != null && file.invalidFileHandle
        == null && this.mode != null) {
      this.save(file.getTitle(), done);
    } else if (file != null && file.constructor == LocalFile && file.fileHandle
        != null) {
      ...
      var saveFunction = mxUtils.bind(this,
          function (name, mode, input, folderId) {
            if (name != null && name.length > 0) {
              ...
              if (/(\.pdf)$/i.test(name)) {
                this.confirm(mxResources.get('didYouMeanToExportToPdf'),
                    mxUtils.bind(this, function () {
                      this.hideDialog();
                ...
                if (prev == null && mode == App.MODE_DEVICE) {
                  ...
                  this.openLink(this.getUrl(window.location.pathname), null,
                      true);
                } else if (prev != mode) {
      ...
      if (urlParams['save-dialog'] != '0') {
        ...
        this.showDialog(dlg.container, 420, 150, true, false,
            mxUtils.bind(this, function () {
              this.hideDialog();
            }));
        dlg.init();
        ...
        var dlg = new CreateDialog(this, filename, saveFunction,
            mxUtils.bind(this, function () {
              this.hideDialog();
            }), mxResources.get('saveAs'), mxResources.get('download'), null,
            null, allowTab,
            null, true, rowLimit, null, null, null, this.editor.fileExtensions,
            false);
        this.showDialog(dlg.container, 420,
            (serviceCount > rowLimit) ? 390 : 280, true, true);
        dlg.init();
      }
    }
  }
...
App.prototype.loadTemplate = function (url, onload, onerror, templateFilename,
  ...
  this.editor.loadUrl(realUrl, mxUtils.bind(this, function (responseData) {
    try {
      var data = (!base64) ? responseData : ((window.atob && !mxClient.IS_IE
          && !mxClient.IS_IE11) ?
      ...
      if (isVisioFilename || this.isVisioData(data)) {
        ...
        this.importVisio(this.base64ToBlob(
      ...
      /(\.png)($|\?)/i.test(filterFn) || /(\.v(dx|sdx?))($|\?)/i.test(filterFn)
      ||
 ...
 * @param {number} dy Y-coordinate of the translation.
 */
App.prototype.createFile = function (title, data, libs, mode, done, replace,
    folderId, tempFile, clibs, success) {
  mode = (tempFile) ? null : ((mode != null) ? mode : this.mode);

  if (title != null && this.spinner.spin(document.body,
    ...
    var error = mxUtils.bind(this, function (resp) {
      ...
      if (resp == null && this.getCurrentFile() == null && this.dialog
          == null) {
        this.showSplash();
      } else if (resp != null) {
        this.handleError(resp);
    ...
    try {
      ...
      if (mode == App.MODE_GOOGLE && this.drive != null) {
        if (folderId == null && this.stateArg != null && this.stateArg.folderId
            != null) {
        ...
        this.gitHub.insertFile(title, data, fileCreated, error, false,
            folderId);
      } else if (mode == App.MODE_GITLAB && this.gitLab != null) {
        this.gitLab.insertFile(title, data, fileCreated, error, false,
            folderId);
      } else if (mode == App.MODE_TRELLO && this.trello != null) {
        this.trello.insertFile(title, data, fileCreated, error, false,
            folderId);
      } else if (mode == App.MODE_DROPBOX && this.dropbox != null) {
        this.dropbox.insertFile(title, data, fileCreated, error);
      } else if (mode == App.MODE_ONEDRIVE && this.oneDrive != null) {
        this.oneDrive.insertFile(title, data, fileCreated, error, false,
            folderId);
      } else if (mode == App.MODE_BROWSER) {
        StorageFile.insertFile(this, title, data, fileCreated, error);
      } else if (!tempFile && mode == App.MODE_DEVICE
          && EditorUi.nativeFileSupport) {
        complete();

        this.showSaveFilePicker(mxUtils.bind(this, function (fileHandle, desc) {
          var file = new LocalFile(this, data, desc.name, null, fileHandle,
              desc);
    ...
    if (id == null || id.length == 0) {
      ...
      if (id.charAt(0) == 'L') {
        ...
        if (!isLocalStorage) {
          ...
          StorageFile.getFileContent(this, id,
        ...
        this.alert(
            ...
            + id.substring(1).substring(0, 10), mxUtils.bind(this, function () {
              window.location.href = 'https://app.diagrams.net/?desc='
                  + id.substring(1);
            }));
      ...
      } else if (id.charAt(0) == 'E') // Embed file
      {
        ...
        if (currentFile == null) {
          ...
          this.remoteInvoke('getDraftFileContent', null, null,
        ...
        var doFallback = mxUtils.bind(this, function () {
          ...
          if (url.substring(0, 31) == 'https://drive.google.com/uc?id=' &&
              (this.drive != null || typeof window.DriveClient
                  === 'function')) {
            this.hideDialog();
            ...
            var fallback = mxUtils.bind(this, function () {
              ...
              if (this.drive != null) {
                ...
                this.loadFile('G' + tempId, sameWindow, null,
                    mxUtils.bind(this, function () {
                      var currentFile = this.getCurrentFile();

                      if (currentFile != null && this.editor.chromeless
                          && !this.editor.editable) {
            ...
            if (!fallback() && this.spinner.spin(document.body,
                mxResources.get('loading'))) {
        ...
        this.loadTemplate(url, mxUtils.bind(this, function (text) {
          ...
          if (text != null && text.length > 0) {
            ...
            var tempFile = new LocalFile(this, text,
        ...
        if (peer == null) {
          this.handleError(
              ...
              mxUtils.bind(this, function () {
                var currentFile = this.getCurrentFile();
                window.location.hash = (currentFile != null)
                    ? currentFile.getHash() : '';
              }));
        } else {
          ...
          if (id != null && id.length > 0 && this.loadedLibraries[id] == null &&
            ...
            if (service == 'L') {
              if (isLocalStorage || mxClient.IS_CHROMEAPP) {
                ...
                window.setTimeout(mxUtils.bind(this, function () {
                  try {
                    ...
                    StorageFile.getFileContent(this, name,
              ...
              try {
                ...
                this.remoteInvoke('getFileContent', [libObj.downloadUrl], null,
              ...
              try {
                this.loadDesktopLib(decodeURIComponent(id.substring(1)),
                    function (desktopLib) {
                      onload(desktopLib);
                    }, onerror);
              } catch (e) {
              ...
              if (peer != null) {
                peer.getLibrary(decodeURIComponent(id.substring(1)),
                    mxUtils.bind(this, function (file) {
                      try {
                        onload(file);
                      } catch (e) {
...
App.prototype.updateButtonContainer = function () {
  if (this.buttonContainer != null) {
    ...
    if (urlParams['embed'] == '1' && Editor.currentTheme != 'simple' &&
      ...
      this.buttonContainer.style.paddingRight = urlParams['atlas'] == '1'
          ? '32px' : '8px';
    }
    ...
    if (this.commentsSupported() && Editor.currentTheme != 'simple' &&
      ...
      if (this.commentButton == null) {
        ...
        mxEvent.addListener(this.commentButton, 'click',
            mxUtils.bind(this, function () {
              this.actions.get('comments').funct();
            }));

        if (this.userElement != null && this.userElement.parentNode
            == this.buttonContainer) {
          this.buttonContainer.insertBefore(this.commentButton,
              this.userElement);
        } else if (this.shareButton != null && this.shareButton.parentNode
            == this.buttonContainer) {
          this.buttonContainer.insertBefore(this.commentButton,
              this.shareButton);
        } else {
    ...
    if (this.getServiceName() == 'draw.io' &&
      ...
      if (file != null) {
        if (this.shareButton == null && Editor.currentTheme != 'atlas') {
          ...
          mxEvent.addListener(this.shareButton, 'click',
              mxUtils.bind(this, function () {
...
App.prototype.fetchAndShowNotification = function (target, subtarget) {
  ...
  var processNotif = mxUtils.bind(this, function (notifs) {
    ...
    var lastRead = isLocalStorage ? parseInt(localStorage.getItem(lsReadFlag))
        : true;
    ...
    mxUtils.get(NOTIFICATIONS_URL, mxUtils.bind(this, function (req) {
      if (req.getStatus() >= 200 && req.getStatus() <= 299) {
        try {
          ...
          if (isLocalStorage) {
            localStorage.setItem(cachedNotifKey,
...
App.prototype.showNotification = function (notifs, lsReadFlag) {
  ...
  function shouldAnimate(newNotif) {
    ...
    notifBell.className = 'geNotification-bell' + (newNotif == 0
        ? ' geNotification-bellOff' : '');
    document.querySelector('.geBell-rad').style.animation = newNotif == 0
        ? 'none' : '';
  }
  ...
  if (this.notificationBtn == null) {
    ...
    this.buttonContainer.insertBefore(this.notificationBtn,
    ...
    mxEvent.addListener(this.notificationBtn, 'click',
        mxUtils.bind(this, function () {
          if (this.notificationWin.style.display == 'none') {
            ...
            this.notificationWin.style.top = (r.top
                + this.notificationBtn.clientHeight) + 'px';
            this.notificationWin.style.left = (r.right
                - this.notificationWin.clientWidth) + 'px';
  ...
  if (notifListEl == null) {
    ...
    for (var i = 0; i < notifs.length; i++) {
      (function (editorUi, notif) {
        ...
        notifEl.innerHTML = '<div class="circle' + (notif.isNew ? ' active'
                : '') + '"></div><span class="time">' +
  ...
  if (enabled && mode == App.MODE_GOOGLE && this.drive != null) {
    ...
    this.drive.pickFolder(mxUtils.bind(this, function (evt) {
      ...
      if (evt.action == google.picker.Action.PICKED) {
        ...
        if (evt.docs != null && evt.docs.length > 0 && evt.docs[0].type
            == 'folder') {
 ...
 *
 */
App.prototype.exportFile = function (data, filename, mimeType, base64Encoded,
    mode, folderId) {
  if (mode == App.MODE_DROPBOX) {
    if (this.dropbox != null && this.spinner.spin(document.body,
        mxResources.get('saving'))) {
      // LATER: Add folder picker
      this.dropbox.insertFile(filename,
          (base64Encoded) ? this.base64ToBlob(data, mimeType) :
    ...
    if (this.drive != null && this.spinner.spin(document.body,
        mxResources.get('saving'))) {
      this.drive.insertFile(filename, data, folderId,
          mxUtils.bind(this, function (resp) {
...
//				}
    ...
    if (this.oneDrive != null && this.spinner.spin(document.body,
        mxResources.get('saving'))) {
      // KNOWN: OneDrive does not show .svg extension
      this.oneDrive.insertFile(filename,
          (base64Encoded) ? this.base64ToBlob(data, mimeType) :
              data, mxUtils.bind(this, function () {
            this.spinner.stop();
          }), mxUtils.bind(this, function (resp) {
    ...
    if (this.gitHub != null && this.spinner.spin(document.body,
        mxResources.get('saving'))) {
    ...
    if (this.trello != null && this.spinner.spin(document.body,
        mxResources.get('saving'))) {
      this.trello.insertFile(filename,
          (base64Encoded) ? this.base64ToBlob(data, mimeType) :
              data, mxUtils.bind(this, function () {
            this.spinner.stop();
          }), mxUtils.bind(this, function (resp) {
...
App.prototype.showAuthDialog = function (peer, showRememberOption, fn,
  ...
  this.showDialog(new AuthDialog(this, peer, showRememberOption,
          ...
          })).container, 300, (showRememberOption) ? 180 : 140, true, true,
      mxUtils.bind(this, function (cancel) {
        if (closeFn != null) {
          closeFn(cancel);
        }
 ...
 */
App.prototype.convertFile = function (url, filename, mimeType, extension,
    success, error, executeRequest, headers) {
  var name = filename;
  ...
  if (this.gitHub != null && url.substring(0, this.gitHub.baseUrl.length)
      == this.gitHub.baseUrl) {
    gitHubUrl = true;
  }

  // Workaround for wrong binary response with VSD(X) & VDX files
  if (/\.v(dx|sdx?)$/i.test(filename) && Graph.fileSupport
    ...
    if (gitHubUrl) {
          ...
          if (success != null) {
            ...
            if (file.encoding === 'base64') {
              if (/\.png$/i.test(filename)) {
                ...
                data = (window.atob && !mxClient.IS_IE && !mxClient.IS_IE11)
      ...
      this.editor.loadUrl(url, handleData, error, binary, null, null, null,
          headers);
    }
  }
};
...
App.prototype.updateHeader = function () {
  if (this.menubar != null) {
    ...
    mxEvent.addListener(this.appIcon, 'click',
        mxUtils.bind(this, function (evt) {
          this.appIconClicked(evt);
        }));
    ...
    mxUtils.setPrefixedStyle(this.appIcon.style, 'transition',
        'all 125ms linear');

    mxEvent.addListener(this.appIcon, 'mouseover',
        mxUtils.bind(this, function () {
          var file = this.getCurrentFile();
          ...
          if (file != null) {
            ...
            if (mode == App.MODE_GOOGLE) {
              this.appIcon.style.backgroundImage = 'url(' + IMAGE_PATH
                  + '/google-drive-logo-white.svg)';
              this.appIcon.style.backgroundSize = '70% 70%';
            } else if (mode == App.MODE_DROPBOX) {
              this.appIcon.style.backgroundImage = 'url(' + IMAGE_PATH
                  + '/dropbox-logo-white.svg)';
              this.appIcon.style.backgroundSize = '70% 70%';
            } else if (mode == App.MODE_ONEDRIVE) {
              this.appIcon.style.backgroundImage = 'url(' + IMAGE_PATH
                  + '/onedrive-logo-white.svg)';
              this.appIcon.style.backgroundSize = '70% 70%';
            } else if (mode == App.MODE_GITHUB) {
              this.appIcon.style.backgroundImage = 'url(' + IMAGE_PATH
              ...
              this.appIcon.style.backgroundImage = 'url(' + IMAGE_PATH
                  + '/gitlab-logo-white.svg)';
              this.appIcon.style.backgroundSize = '100% 100%';
            } else if (mode == App.MODE_TRELLO) {
              this.appIcon.style.backgroundImage = 'url(' + IMAGE_PATH
                  + '/trello-logo-white-orange.svg)';
              this.appIcon.style.backgroundSize = '70% 70%';
            }
          }
        }));

    mxEvent.addListener(this.appIcon, 'mouseout',
        mxUtils.bind(this, function () {
          this.appIcon.style.backgroundImage = logo;
    ...
    // Prevents focus
    mxEvent.addListener(this.fname,
     ...
     */
    var right = (Editor.currentTheme != 'atlas' && urlParams['embed'] != '1')
        ? 30 : 10;
    this.toggleFormatElement = document.createElement('a');
    this.toggleFormatElement.setAttribute('title',
    ...
    this.toggleFormatElement.style.top = (Editor.currentTheme == 'atlas')
        ? '8px' : '6px';
    ...
    this.toggleFormatElement.className = (Editor.currentTheme != 'atlas')
        ? 'geButton geAdaptiveAsset' : '';
    ...
    // Prevents focus
    mxEvent.addListener(this.toggleFormatElement,
        (mxClient.IS_POINTER) ? 'pointerdown' : 'mousedown',
        mxUtils.bind(this, function (evt) {
          evt.preventDefault();
        }));

    mxEvent.addListener(this.toggleFormatElement, 'click',
        mxUtils.bind(this, function (evt) {
    ...
    var toggleFormatPanel = mxUtils.bind(this, function () {
      if (this.formatWidth > 0) {
        this.toggleFormatElement.style.backgroundImage = 'url(\''
            + this.formatShowImage + '\')';
      } else {
        this.toggleFormatElement.style.backgroundImage = 'url(\''
            + this.formatHideImage + '\')';
      }
    });
    ...
    this.fullscreenElement.style.backgroundImage = 'url(\''
    ...
    mxEvent.addListener(this.fullscreenElement, 'click',
        mxUtils.bind(this, function (evt) {
    ...
    if (urlParams['embed'] != '1' && Editor.currentTheme != 'atlas') {
      ...
      this.toggleElement.setAttribute('title',
      ...
      // Prevents focus
      mxEvent.addListener(this.toggleElement,
          (mxClient.IS_POINTER) ? 'pointerdown' : 'mousedown',
          mxUtils.bind(this, function (evt) {
            evt.preventDefault();
          }));
      ...
      mxEvent.addListener(this.toggleElement, 'click',
          mxUtils.bind(this, function (evt) {
      ...
      if (!mxClient.IS_FF && screen.height <= 740
...
App.prototype.toggleUserPanel = function () {
  if (this.userPanel == null) {
    ...
    mxEvent.addListener(document.body, 'click',
        mxUtils.bind(this, function (evt) {
          if (!mxEvent.isConsumed(evt) && this.userPanel != null
...
//									file.close();
        ...
        var createUserRow = mxUtils.bind(this, function (user) {
          ...
          img.setAttribute('border', '0');
          img.setAttribute('src', (user.pictureUrl != null) ? user.pictureUrl
        ...
        var btn = mxUtils.button(mxResources.get('signOut'),
            mxUtils.bind(this, function () {
              this.confirm(mxResources.get('areYouSure'),
                  mxUtils.bind(this, function () {
                    closeFile(mxUtils.bind(this, function () {
                      this.stateArg = null;
                      this.drive.logout();
        ...
        var btn = mxUtils.button(mxResources.get('addAccount'),
            mxUtils.bind(this, function () {
    ...
    if (this.dropbox != null) {
      addUser(this.dropbox.getUser(), IMAGE_PATH + '/dropbox-logo.svg',
          mxUtils.bind(this, function () {
            var file = this.getCurrentFile();
    ...
    if (this.oneDrive != null) {
      addUser(this.oneDrive.getUser(), IMAGE_PATH + '/onedrive-logo.svg',
          this.oneDrive.noLogout ? null : mxUtils.bind(this, function () {
            var file = this.getCurrentFile();
    ...
    if (this.gitHub != null) {
      addUser(this.gitHub.getUser(), IMAGE_PATH + '/github-logo.svg',
          mxUtils.bind(this, function () {
            var file = this.getCurrentFile();
    ...
    if (this.gitLab != null) {
      addUser(this.gitLab.getUser(), IMAGE_PATH + '/gitlab-logo.svg',
          mxUtils.bind(this, function () {
            var file = this.getCurrentFile();
    ...
    if (this.trello != null) {
      addUser(this.trello.getUser(), IMAGE_PATH + '/trello-logo.svg',
          mxUtils.bind(this, function () {
            var file = this.getCurrentFile();
